        ...
        <div className="footer__col2 ">
            ...
            <li><h4 className="text-white align-center mt-4">Developed by</h4></li>
              ...
              <li className="d-flex justify-content-center">
                <img className="inline-block align-center h-20 image-center mt-2" src="../assets/TJDev.png" alt="logo"/></li>
              </div>
      ...
      <div className="copyright">
        <div className="container">
          ...
          <p className="col-sm d-flex justify-content-center text-center">
            &copy;{new Date().getFullYear()} Technojet.Dev | Design by PSIX | Beta v.121121.19
          </p>
