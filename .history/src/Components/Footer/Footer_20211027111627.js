      ...
      <div className="container d-flex align-items-center ">
        <div className="footer__col1">
          ...
          <div class="shake-slow shake-constant shake-constant--hover">
           <img  src="../Assets/logo.svg" className="w-50 shake-slow shake-constant shake-constant--hover" alt="logo" />
        ...
        <div className="footer__col2 ">
            ...
            <li><h4 className="text-white align-center mt-4">Developed by</h4></li>
              <li className="d-flex justify-content-center"><img className="inline-block align-center h-20 image-center" src="../assets/TJDev.png" alt="logo"/></li>
