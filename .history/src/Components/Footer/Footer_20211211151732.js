      ...
      <div className="copyright">
        <div className="container">
          ...
          <p className="col-sm d-flex justify-content-center">
            &copy;{new Date().getFullYear()} Technojet.Dev | Design by <strong> <a href="https://technojetdev.netlify.app/" className="text-decoration-none text-white"> PSIX </a></strong> 
          </p>
