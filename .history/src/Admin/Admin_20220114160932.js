...
function InstiCount(){
  ...
  const collectionRef = query(collection(admindb, "userdata"), where("Institution", "==", "PUP"));
const q = query(collectionRef);
onSnapshot(q, (snapshot) =>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-xl-3 col-sm-6 mb-3">
                                            <div className="card text-white bg-danger o-hidden h-100">
                                                ...
                                                <div className="mr-5"><strong>{institution.length}</strong>Enrolled/Working in PUP</div>
                                                </div>
                                            </div>
                                        </div>
