...
const Admin = () => {
    ...
    <div class="header pb-8 pt-5 pt-lg-8 d-flex align-items-center" style={{min-height: 600px; backgroundmage: "url(https://raw.githack.com/creativetimofficial/argon-dashboard/master/assets/img/theme/profile-cover.jpg)", backgroundSize: "cover", backgroundPosition: "center top"}}>
