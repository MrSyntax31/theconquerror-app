...
const Admin = () => {
    ...
    <div class="header pb-8 pt-5 pt-lg-8 d-flex align-items-center" style={{min-height: 600px; background-image: url(https://raw.githack.com/creativetimofficial/argon-dashboard/master/assets/img/theme/profile-cover.jpg); background-size: cover; backgroundPosition: "center top"}}>
