                                    ...
                                    <Offcanvas show={showOff} onHide={handleCloseOff}>
                                      ...
                                      <Offcanvas.Body>
                                          ...
                                          <div className=" d-grid gap-2 mt-3 mb-3">
                                            <Button variant="primary" onClick={handleShow5} className="mb-2 w-50 mx-auto d-block"><AiIcons.AiFillProfile/> Update Information</Button> 

                                            <Button variant="primary" onClick={handleShow4} className="mb-2 w-50 mx-auto d-block"><AiIcons.AiFillFileText/> Upload Files</Button> 
                                            
                                            <Button variant="primary" onClick={handleShow} className="mb-2 w-50 mx-auto d-block"><AiIcons.AiFillLock/> Change Password</Button> 
                                          
                                            <Button variant="primary" onClick={handleShow2} className="mb-2 w-50 mx-auto d-block"><AiIcons.AiOutlineWechat/> Send Feedback</Button> 
