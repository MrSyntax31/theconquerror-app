                                ...
                                <Row>
                                  ...
                                  <Card style={{ width: '18rem', marginTop: '2rem' }}>
                                    <div style={{textAlign:"center"}}>
                                      <Card.Img variant="top" className="mt-2 w-50" src="https://cdn-icons.flaticon.com/png/512/4680/premium/4680872.png?token=exp=1637652662~hmac=67914cf7d049e04023e71b628485d3dd" />
                                    </div>
                                    <Card.Body>
                                      ...
                                      <Link to="/courses" style={{ textDecoration: 'none', marginLeft:'1rem' }} className="btn btn-primary mb-4">Go somewhere</Link>
                                    </Card.Body>
                                  </Card>
