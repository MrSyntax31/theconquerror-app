       ...
       <Navbar/>
        ...
        <div className="mt-5" style={{ textAlign: "center" }}>
            ...
            <div className="App">
              ...
              <Container className="mx-auto d-block"  style={{ width: '100%', height: 600, marginTop:'4rem', marginBottom:'4rem'}}>

                          <ResponsiveContainer width="100%" height="100%" className="mx-auto d-block">
