        ...
        <div className="mt-5" style={{ textAlign: "center" }}>
            ...
            <div className="App">
              ...
              <Container fluid="md" style={{
                    ...
                    <div style={{ width: '100%', height: 500, marginTop:'4rem', marginBottom:'4rem' }} className="mx-auto d-block">
                    <ResponsiveContainer width="100%" height="100%" >
                            <RadarChart cx={150} cy={250} outerRadius={150} width={500} height={500} data={data}>
                              <PolarGrid />
