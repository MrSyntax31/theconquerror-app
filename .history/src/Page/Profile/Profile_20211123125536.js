    ...
    return (
      ...
      <Container fluid="md" style={{
        ...
        {/* Card for User Profile Information */}
                        <Card>
                            <Card.Body>
                                        <h1 className="text-center">Welcome ConquError Warrior</h1>
                                <Row>
                                    ...
                                    <Row className=" mt-3">
                                            ...
                                            <div className="text-right">
                                              <Button variant="primary" onClick={handleShowOff}><IoIcons.IoSettingsSharp/> Settings</Button>
                                            </div>
                                    ...
                                    <Offcanvas show={showOff} onHide={handleCloseOff}>
                                      ...
                                      <Offcanvas.Body>
                                        <Row xs="auto" className="d-flex justify-content-center mt-3">
...
<div className="" id="container-floating">


  <div id="floating-button" data-toggle="tooltip" data-placement="left" data-original-title="Create" onclick="newmail()">
    <p variant="primary" className="text-light fs-3" style={{marginTop: "15px"}} onClick={handleShowOff}><IoIcons.IoSettingsSharp/></p>
  </div>
