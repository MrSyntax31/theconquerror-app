                                ...
                                <Row>
                                    ...
                                    <Modal show={show} onHide={handleClose} backdrop="static" keyboard={false} >
                                          ...
                                          <Modal.Body>
                                            <div className=""> Current Password: <br></br>
                                                ...
                                                <i onClick={showPass} className={'fas fa-eye'}>Show/Hid Password</i>
                                            </div>
                                    ...
                                    <Modal show={show5}  onHide={handleClose5} backdrop="static"  keyboard={false}  >
                                          ...
                                          <Form.Group id="" className="mb-2">
                                            ...
                                            <Form.Control value={ address || profile.Address} onChange={e => setAddress(e.target.value)}  name = "name" type="name" required placeholder="Enter Address"/>
                                          </Form.Group>
                                        ...
                                        <option value="Others">Select Occupation</option>
                                        <option value="Student">Student</option>
                                        <option value="Professor">Professor</option>
                                        <option value="Others">Others.</option>
                                        </Form.Select>
                                        { occuHide &&  <Form.Control  className="mt-2" value={occu } onChange={e => setOccu(e.target.value)}  name = "Occupation" type="text"  required placeholder="Enter Occupation" /> }
                                        </Form.Group>
                                        ...
                                        <option value="Others">Select Institution</option>
                                        ...
                                        { instiHide &&  <Form.Control className="mt-2" value={insti} onChange={e => setInsti(e.target.value)}  name = "Institution" type="text"  required placeholder="Enter Institution"/> }
