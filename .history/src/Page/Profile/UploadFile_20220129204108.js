  ...
  return <div className="backGround">
      {/* Helmet */}
            ...
            <div className="col-md-6 offset-md-3 mt-5 mb-5 container">
                ...
                <div className="mb-3" >
                    <img  caassName="imgProf" alt="" src='https://firebasestorage.googleapis.com/v0/b/conquerror-development.appspot.com/o/Homepage%2Flogo.svg?alt=media&token=274fc263-dba7-4b50-a713-636284493fdc'/>
                </div>
