                        ...
                        <div className="row">
                          <div className="col">
                            <div className="card-profile-stats d-flex justify-content-center mt-md-5">
                              <div>
                                <span className="heading">{profile.level}/15</span>
                      ...
                      <div className="card-header bg-white border-0">
                        <div className="row align-items-center">
                          ...
                          <div className="col-4 text-right">
                            <p onClick={handleShowOff} className="btn btn-sm btn-primary"><IoIcons.IoSettingsSharp/> Settings</p>
                          </div>
                        </div>
                      </div>
                        ...
                        <form>
                          ...
                          <div className="pl-lg-4">
                            <div className="row">
                              <div className="col-lg-6">
                                <div className="form-group focused">
                                  <label className="form-control-label text-white" for="input-username">Full Name</label>
                            ...
                            <div className="row">
                              <div className="col-lg-6">
                                <div className="form-group focused">
                                  <label className="form-control-label" for="input-first-name">Birthday</label>
                                  <input type="text" id="input-first-name" className="form-control form-control-alternative" value={profile.Birthday || ''} disabled/>
                                </div>
                              </div>
                              <div className="col-lg-6">
                                <div className="form-group focused">
                                  <label className="form-control-label" for="input-last-name">Gender</label>
                          ...
                          <div className="pl-lg-4">
                            ...
                            <div className="row">
                              <div className="col-lg-4">
                                <div className="form-group focused">
                                  <label className="form-control-label" for="input-city">Occupation</label>
                                  <input type="text" id="input-city" className="form-control form-control-alternative" value={profile.Occupation || ''} disabled/>
                                </div>
                              </div>
                              <div className="col-lg-8">
                                <div className="form-group focused">
                                  <label className="form-control-label" for="input-country">Institution</label>
                          ...
                          <div className="pl-lg-4">
                            <div className="form-group focused">
                              ...
                              <textarea rows="4" className="form-control form-control-alternative" disabled="disabled">A beautiful Dashboard for Bootstrap 4. It is Free and Open Source.</textarea>
                            </div>
                          </div>
                        </form>
                      </div>
