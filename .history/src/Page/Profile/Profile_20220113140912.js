        ...
        <div className="mt-5" style={{ textAlign: "center" }}>
            ...
            <Offcanvas show={showOff} onHide={handleCloseOff}>
                                      ...
                                      <Modal show={show2}  onHide={handleClose2} backdrop="static"  keyboard={false}  >
                                            ...
                                            <Modal.Body>
                                              <strong>Please Upload any Picture of Credential that will Prove that you are Qualified to Provide Learning Materials</strong>
                                           <input type="file" 
                                          onChange={changeHandler}/>
                                            ...
                                            <Modal.Footer>
                                              ...
                                              <Button variant="secondary" onClick={uploadCred}>
                                                Upload
                                              </Button>
                                            </Modal.Footer>
                                          </Modal>
