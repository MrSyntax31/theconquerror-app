                                ...
                                <Row>
                                    ...
                                    <Offcanvas show={showOff} onHide={handleCloseOff}>
                                      ...
                                      <Offcanvas.Body>
                                          ...
                                          <div className=" d-grid gap-2 mt-3 mb-3 mx-auto d-block">
                                            <Button variant="primary" onClick={handleShow5} className="mb-2 w-50"><AiIcons.AiFillProfile/> Update Information</Button> 

                                            <Button variant="primary" onClick={handleShow4} className="mb-2 w-50"><AiIcons.AiFillFileText/> Upload Files</Button> 
                                            
                                            <Button variant="primary" onClick={handleShow} className="mb-2 w-50"><AiIcons.AiFillLock/> Change Password</Button> 
                                          
                                            <Button variant="primary" onClick={handleShow2} className="mb-2 w-50"><AiIcons.AiOutlineWechat/> Send Feedback</Button> 
