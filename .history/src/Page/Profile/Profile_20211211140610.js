...
function updateProfile(){ 
  ...
  const newPostKey = push(child(ref(realtimedb), 'users')).key;
                                ...
                                <Row>
                                    ...
                                    <Modal show={show5}  onHide={handleClose5} backdrop="static"  keyboard={false}  >
                                          ...
                                          <Form.Group id="" className="mb-2">
                                            ...
                                            <Form.Control value={profile.Address} onChange={e => setEmail(e.target.value)}  name = "name" type="name" placeholder="Address"/>
                                          </Form.Group>
