                            ...
                            <Card.Body>
                                ...
                                <Row>
                                  ...
                                  <Card style={{ width: '18rem', marginTop: '2rem' }}>
                                    <Card.Img variant="top" className="mt-2 w-50 align-center" src="https://cdn-icons.flaticon.com/png/512/2157/premium/2157113.png?token=exp=1637651929~hmac=9cf58fee33e5f588fce2e6ddc4bdf4c4" />
                                    <Card.Body>
                                      <Card.Title>My level: <strong>{profile.level}</strong> </Card.Title>
                                      <Card.Text>
                                        Level 1: You are about to discover 
                                      </Card.Text>
