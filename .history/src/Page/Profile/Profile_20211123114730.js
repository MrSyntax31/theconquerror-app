  ...
  //creating reference for realtimedb and fetching data from table users using the userID as reference then setting the data inside the Profile useState above
    ...
    return (
        ...
        <div className="" style={{marginTop:"8rem", marginLeft:"10%"}}>
            <Row className=" mt-3">
                                          ...
                                          <Col sm={4} className="text-right">
                                            <p className="fs-4 text-right"variant="light" onClick={handleShowOff}><FcIcons.FcSettings/> Settings</p>
                                          </Col>
            </Row>
      ...
      <div style={{ textAlign: "center" }}>
          ...
          <p className="fs-4 text-right"variant="light" onClick={handleShowOff}><FcIcons.FcSettings/> </p>
        </a>
      </div>
    </>
    )
