...
const Profile = () => {
  ...
  function InstitutionValue(){

    const instival = insti.current.value
    console.log(instival)
    if(instival === "Others"){
                            ...
                            <Card.Body>
                                ...
                                <Row>
                                    ...
                                    <Modal show={show5}  onHide={handleClose5} backdrop="static"  keyboard={false}  >
                                        ...
                                        <Form.Select aria-label="Default select example" ref={ insti } onChange={InstitutionValue(e)} required>
