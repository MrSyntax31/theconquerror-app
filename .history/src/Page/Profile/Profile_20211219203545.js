 ...
 return result;
  ...
  function changePass(){
    ...
    if (newPass1 !== newPass2)
    {
      ...
      swal("Update", "You just changed your password, Try Again Later", "warning");
    }
...
function updateProfile(){ 
  ...
  if (sessionStorage.getItem('UpdateKey') === null) {
    ...
    swal("Update", "You recently updated your Profile, Try Again Later", "warning");
                                ...
                                <Row>
                                    ...
                                    <Modal show={show5}  onHide={handleClose5} backdrop="static"  keyboard={false}  >
                                          ...
                                          <Form.Group id="" className="mb-2">
                                            ...
                                            <Form.Control value={ address || profile.Address } onChange={e => setAddress(e.target.value)}  name = "name" type="name" required placeholder="Enter your Address"/>
                                          </Form.Group>

                                          <Form.Group id="gender">
                                            <Form.Label>Gender</Form.Label>
                                            <Form.Select aria-label="Default select example" value={ gender || profile.Gender  } onChange={e => setGender(e.target.value)} required>
                                        ...
                                        <Form.Select aria-label="Default select example" value={occu || profile.Occupation } onChange={e => OccupationValue(e)} required>
                                        <option value="Others">Others.</option>
                                        <option value="Student">Student</option>
                                        <option value="Professor">Professor</option>
                                        
                                        </Form.Select>
                                        { occuHide &&  <Form.Control  className="mt-2" value={occu || "" } onChange={e => setOccu(e.target.value)}  name = "Occupation" type="text" pattern="[a-zA-Z\s]*" required placeholder="Enter Occupation" /> }
                                        ...
                                        { instiHide &&  <Form.Control className="mt-2" value={ insti || ""} onChange={e => setInsti(e.target.value)}  name = "Institution" type="text"  pattern="[a-zA-Z\s]*" required placeholder="Enter Institution"/> }
                                        <Form.Control.Feedback type="invalid">
                                         Do not use special characters.
                                         </Form.Control.Feedback>
                                        </Form.Group>
