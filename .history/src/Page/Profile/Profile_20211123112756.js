  ...
  //creating reference for realtimedb and fetching data from table users using the userID as reference then setting the data inside the Profile useState above
    ...
    return (
       ...
       <Navbar/>
        ...
        <Row className=" mt-3">
                                          <Col sm={8}><h2 className="mt-5 text-primary fw-bold">User Dashboard</h2></Col>
                                          <Col sm={4}>
                                            <Button variant="primary" onClick={handleShowOff}><GoIcons.GoCommentDiscussion/> Settings</Button>
                                          </Col>
                                    </Row>
