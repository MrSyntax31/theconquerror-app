       ...
       <Navbar/>
        ...
        <div className="mt-5" style={{ textAlign: "center" }}>
            ...
            <div className="App">
              ...
              <Container className="mx-auto d-block" fluid="md" style={{ width: '100%', height: 600, marginTop:'4rem', marginBottom:'4rem', display: "flex",
                     justifyContent: "center",
                     alignItems: "center" }}>

                          <ResponsiveContainer width="100%" height="100%" fluid="md" style={{ width: '100%', height: 600, marginTop:'4rem', marginBottom:'4rem', display: "flex",
                     justifyContent: "center",
                     alignItems: "center" }}>>
