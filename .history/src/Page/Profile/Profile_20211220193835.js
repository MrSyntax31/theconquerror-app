    ...
    return (
                            ...
                            <Card.Body>
                              ...
                              { profile &&
                                  <Card style={{ width: '18rem', marginTop: '2rem' }}>
                                    ...
                                    <Card.Body >
                                      <Card.Title className="text-center">My level: <strong>{profile.level}</strong> </Card.Title>
                                      <br/>
      ...
      <div style={{ textAlign: "center" }}>
          ...
          <div className="App">
            ...
            <iframe src="https://open.spotify.com/embed/track/39LLxExYz6ewLAcYrzQQyP?utm_source=generator" width="100%" height="80" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>
          </div>              
