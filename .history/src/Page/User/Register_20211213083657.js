                ...
                <h3 className="text-center mb-4 text-primary fw-bold">Register</h3>
                      ...
                      <div className="form-row">
                            ...
                            <div className="value">
                                ...
                                <Form.Control  value={password || ''} onChange={e => setPass(e.target.value)}  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" name = "password" type={passwordH  Na} autoComplete="new-password" required placeholder="Password"/>
                                <Form.Control.Feedback type="invalid">
