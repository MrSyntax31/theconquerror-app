    ...
    export default function ForgotPass() {
       ...
       function onChange(value) {
          ...
          setHandler(true);
           ...
           async function onResetpass () {
            ...
            .then(() => {
              ...
              // ..
              swal("Email Sent!", "Please check your email, Request for Reset password has been sent!", "success");
              setEmail("");
            })
            .catch((error) => {
          //    const errorCode = error.code;
              ...
              swal("Please verify that you are not a robot!", "", "error");
            }
            }
...
<div>
      <Helmet>
        ...
        <meta name="description" content="Welcome to the ConquError Forgot password" />
      </Helmet>
    </div> 
