                    ...
                    <Form noValidate validated={validated} className="">
                      <div className="form-row">
                            ...
                            <div className="value">
                                ...
                                <Form.Control  onChange={ e => setField('name', e.target.value) }  name = "email" type="email" autoComplete="username" required placeholder="Email Address"/>
                                ...
                                <Form.Control  onChange={ e => setField('name', e.target.value) }  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" name = "password" type="password" autoComplete="new-password" required placeholder="Password"/>
                                <Form.Control.Feedback type="invalid">
