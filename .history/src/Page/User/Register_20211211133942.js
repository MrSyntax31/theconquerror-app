                      ...
                      <div class="form-row">
                        ...
                        <div className="form-row">
                            ...
                            <div className="value">
                              ...
                              { occuHide &&  <Form.Control  className="mt-2" value={occu } onChange={e => setOccu(e.target.value)}  name = "Occupation" type="text"  required placeholder="Please Specify"/> </Form.Control>  <Form.Control.Feedback type="invalid">
                               Please enter a proper Occupation.
                                  </Form.Control.Feedback>
                                    <Form.Control.Feedback>Looks good!</Form.Control.Feedback> }
                              </Form.Group>
