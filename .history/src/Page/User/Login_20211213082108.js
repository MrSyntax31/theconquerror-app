...
export default function Login() {
    ...
    const [sesh, setKey] = useState(false);
                              ...
                              {error && <Alert variant="danger">{error}</Alert>}
                                <Form noValidate validated={validated} className="">
                                  ...
                                  <Form.Group id="password" className="mb-3">
                                    ...
                                    <Form.Control type={this.state.type} ref={passwordRef}  name = "password" autoComplete="current-password" required placeholder="Password"/>
                                      <Form.Control.Feedback type="invalid">
