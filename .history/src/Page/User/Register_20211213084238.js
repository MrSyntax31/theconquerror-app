      ...
      <div className="background-area" id="particles-js">
        ...
        <div className="wrapper wrapper--w900">
            <div className="card card-6">
                ...
                <p>By clicking the Sign-up button, you agree to our <a href="" variant="primary"  onClick={handleShow} className="text-primary text-decoration-underline mb-3" >Terms and Conditions</a>.</p>
