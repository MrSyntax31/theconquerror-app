      ...
      <div className="background-area" id="particles-js">
        ...
        <div class="wrapper wrapper--w900">
            <div class="card card-6">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                              ...
                              <Form.Label>First Name</Form.Label>
                                <Form.Control  type="text" id="fname" value={fname || ''} onChange={e => setFname(e.target.value)} name="fname" pattern="[a-zA-Z]*" required placeholder="First Name"/>
                              </Form.Group>
                ...
                {/* Modal Button */}
                <Button variant="primary" type="submit" onClick={handleShandleShowubmit}>
                  Submit
                </Button>
                ...
                <Modal show={show} onHide={handleClose}>
                  ...
                  <Modal.Body>
                    <p>
                      ...
                      Donec lobortis lorem ut velit congue, eget mattis sem
                      mattis. Sed euismod, urna eget aliquet egestas, nisl
                      urna aliquet nunc, eget maximus nisl urna eget
                      aliquet egestas.
                    </p>
                    <p>
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
