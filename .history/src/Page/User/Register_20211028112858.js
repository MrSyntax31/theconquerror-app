...
<Container className="d-flex align-items-center justify-content-center mt-5 mb-5" style={{ minHeight: "100vh"}}>
     <div className="w-100 m-5" style={{ maxWidth: "400px"}}>
                ...
                <Form.Group id="checkAgree" className="mt-1" required>
                {['checkbox'].map((type) => (
