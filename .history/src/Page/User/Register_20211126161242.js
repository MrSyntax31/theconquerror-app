      ...
      <div className="background-area" id="particles-js">
        ...
        <div class="wrapper wrapper--w900">
            <div class="card card-6">
                <div class="">
                  <Row>
                    <Col><h4 class="title">Become a warrior!</h4></Col>
                    <Col><img variant="top" className="mt-2 w-25" src="https://cdn-icons-png.flaticon.com/512/3763/3763359.png" alt="img-header" /></Col>
                  </Row>
