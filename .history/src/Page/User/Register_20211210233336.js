        ...
        <div class="wrapper wrapper--w900">
            <div class="card card-6">
                    ...
                    <form>
                      <div class="form-row">
                            ...
                            <div class="value">
                                ...
                                <input value={password2 || ''} onChange={e => setPass2(e.target.value)}   name = "password" type="password" autoComplete="new-password" required placeholder="Password"/>
                                </Form.Group>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                              ...
                              <Form.Label>Last Name</Form.Label>
                                <input value={lname || ''} onChange={e => setLname(e.target.value)}   name = "name" type="name" placeholder="Last Name"/>
                              </Form.Group>
                              ...
                              { occuHide &&  <input className="mt-2" value={occu } onChange={e => setOccu(e.target.value)}  name = "Occupation" type="text"  required placeholder="Please Specify"/> }
                              </Form.Group>
                              ...
                              { instiHide &&  <input className="mt-2" value={insti} onChange={e => setInsti(e.target.value)}  name = "Institution" type="text"  required placeholder="Please Specify"/> }
                              </Form.Group>
                ...
                <div class="card-footer">
                  ...
                  <Button type="submit" value="submit" className="btn btn-primary mt-3 w-100" onClick={onRegister} >Sign Up</Button>
