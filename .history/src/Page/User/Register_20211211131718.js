        ...
        // Register Code
         // Register Code
          ...
          const findFormErrors = () => {
            const { email, firstname, lastname, password, password2, gender, occupation, institution } = form
            const newErrors = {}
            // name errors
            if ( !first || email === '' ) newErrors.email = 'cannot be blank!'
            else if ( name.length > 30 ) newErrors.firstname = 'name is too long!'
            // food errors
                    ...
                    <Form noValidate validated={validated} className="">
                      <div className="form-row">
                            ...
                            <div className="value">
                                ...
                                <Form.Control  onChange={ e => setField('password2', e.target.value) }  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"  name = "password" type="password" autoComplete="new-password" required placeholder="Password"/>
                        ...
                        <div className="form-row">
                            ...
                            <div className="value">
                              ...
                              <Form.Control as='select' onChange={ e => setField('occupation', e.target.value) } required>
                                <option value="">Select Occupation</option>
                                <option value="Student">Student</option>
                                <option value="Professor">Professor</option>
                                <option value="Others">Others.</option>
                              </Form.Control>
                              { occuHide &&  <Form.Control  className="mt-2" onChange={ e => setField('occupation', e.target.value) }  name = "Occupation" type="text"  required placeholder="Please Specify"/> }
                              </Form.Group>

                              <Form.Group id="inst">
                              <Form.Label>Institution</Form.Label>
                              <Form.Control as='select' onChange={ e => setField('institution', e.target.value) } required>
                              ...
                              { instiHide &&  <Form.Control className="mt-2" onChange={ e => setField('institution', e.target.value) }  name = "Institution" type="text"  required placeholder="Please Specify"/> }
                              </Form.Group>
