...
import { Form, Button, Container, Alert, Row, Col, iNPUT} from 'react-bootstrap'
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                              ...
                              <Form.Control value={fname || ''} onChange={e => setFname(e.target.value)}  name = "name" type="name" pattern="[A-Za-z]" required placeholder="First Name"/>
