...
const Games = () => {
    ...
    <h3>Hangman</h3>
    <p className="mt-3 mb-5">Try to test and figure out programming terms, and words in a guessing game.</p>
    ...
    <h3>Error Puzzle</h3>
    <p className="mt-3 mb-5">ConquError, will tease your brain to solve this sliding number puzzle.</p>
