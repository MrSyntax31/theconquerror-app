...
<Navbar/>
      ...
      <div className="bg-light"style={{marginTop:'4rem'}}>
               {/* Section for Home Top Background Image*/}
               <section id="home" className="hero-area">
                     <div className="container">
                        <div className="row align-items-center">
                           <div className="col-lg-5 col-md-12 col-12">
                              <div className="hero-content">
                                 <h1 className="wow fadeInLeft" data-wow-delay=".4s">A Learning Management System. Your great partner in learning all about IT.</h1>
                                 <p className="wow fadeInLeft" data-wow-delay=".6s">Be part of our learning community, with us let's Conquer errors.</p>
                     ...
                     <div className="row">
                        <div className="col-lg-4 col-md-6 col-12">
                           <div className="single-feature wow fadeInUp" data-wow-delay=".2s">
                              ...
                              <p>
                              Inside Basic Programming Course, you can learn, and identify different basic structures of programming, understand basic problem concepts and formulate your own set of codes.</p>
                           </div>
                        </div>
                        <div className="col-lg-4 col-md-6 col-12">
                     ...
                     <div className="container">
                        <div className="row">
                           <div className="col-lg-10 offset-lg-1 col-md-12 col-12">
                              <div className="title">
                                 <h2>Trusted by students from over [Number of ConquError Warrior]</h2>
                              </div>
                           </div>
                        </div>
                        <div className="row">
                     ...
                     <div className="col-md-4">
                        <div className="testimonial mb-5">
                           <div className="avatar mx-auto">
                              ...
                              Software undergoes beta testing shortly before it’s released. Beta is Latin for still doesn’t work.</p>
                        </div>
                     </div>
                        ...
                        <div className="col-md-4">
                           <div className="testimonial mb-5">
                              <div className="avatar mx-auto">
                                 ...
                                 <p className="font-weight-normal dark-grey-text">You know you're that good, if you procrastinate because you already figured out the Algorithm in your head.</p>
                           </div>
                        </div>
                        ...
                        <div className="col-md-4">
                           <div className="testimonial mb-5">
                              <div className="avatar mx-auto">
                                 <img src="../assets/user-04.jpg" className="rounded-circle z-depth-1 img-fluid" alt="developer"/>
                              </div>
                                 ...
                                 <p className="font-weight-normal dark-grey-text">Imagination is more important than knowledge. Life is like riding a bicycle. To keep your balance you must keep moving. Imagination is everything. It is the preview of life's coming attractions. -Albert Einstein</p>
                           </div>
                        </div>
                        ...
                        <div className="col-md-4">
                           <div className="testimonial mb-5">
                              <div className="avatar mx-auto">
                                 <img src="../assets/TJDev.png" className="rounded-circle z-depth-1 img-fluid" alt="developer"/>
                              </div>
                              ...
                              <Accordion>
                                 <Accordion.Item eventKey="0">
                                    <Accordion.Header>What if I have Questions?</Accordion.Header>
                                       <Accordion.Body> If you have any concern or questions, please do contact ConquError and we will get in touch with you.
                                       
                                                   <p className="h05">Email Us At.</p>
                                                      <ul className="list-links">
                                                         <li>
                                                            <a href="https://mail.google.com/mail/u/0/?tab=om#inbox">technojet.devofficial@gmail.com</a>
                                                         </li>
                                                      </ul>
                                       </Accordion.Body>
                                 </Accordion.Item>
                                 ...
                                 <Accordion.Item eventKey="1">
                                    <Accordion.Header>What is ConquError?</Accordion.Header>
                                       <Accordion.Body><strong>ConquError</strong> is a digital learning platform developed by Technojet.Dev. We are composed of creative designers, programmers, and researchers which aim to help students, professionals, and researchers in learning IT related courses.
                                 ...
                                 <Accordion.Item eventKey="2">
                                    <Accordion.Header>How to enroll in ConquError?</Accordion.Header>
                                       <Accordion.Body>You can Enroll by Creating an Account first. <Link to="/register" style={{ textDecoration: 'none' }}>Register Here!</Link> Having an Account can give you access to all of ConquError. Oh! i forget to tell you, It's All FREE.</Accordion.Body>
                                 </Accordion.Item>
