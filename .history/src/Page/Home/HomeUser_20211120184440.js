...
import { Carousel, Accordion, Row, Col } from 'react-bootstrap';
            ...
            <section id="" className="features section">
               <div className="container">
                  ...
                  <div className="row justify-content-center">
                     <div className="">
                        <div className="" data-wow-delay=".4s"col-lg-4 col-md-6 col-12 mb-3>
                           <iframe title= "Video1" className="" width="315" height="315" src="https://www.youtube.com/embed/jcYaWFhV8oY" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen ></iframe>
                        </div>
                     </div>
