        ...
        <>
            ...
            <div className="bg-light"style={{marginTop:'4rem'}}>
               ...
               <section className="our-achievement section">
                  ...
                  <h1 id="liveVisitTitle" style={{textAlign: "center"}} className="montRegular veryLargeSize white"><span class="montBlack">Live</span> Visit Count</h1>
                  <p id="liveVisitDescription" style="text-align: center;" class="montRegular headerSize white">Total Number of Individuals Visiting the Website.</p>
