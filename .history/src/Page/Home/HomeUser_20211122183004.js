      ...
      <div className="bg-light"style={{marginTop:'4rem'}}>
            ...
            <section className="bg-light" id="about" >
               <Container fluid="md" style={{
                  ...
                  <Row>
                     ...
                     <p className="mt-4 mb-5 text-justify fs-6">At <strong>ConquError</strong>, we believe everyone deserves to learn computer programming and other IT related courses for free. Innovation and simplicity makes us happy and contented: Our mission is to provide a better way of learning technology related courses,
            ...
            <section className="" id="destinations">   
               <Container fluid="md" style={{
                  ...
                  <Row>          
                     <div className="mt-5">
                        <h3 className="text-center text-secondary">Available Courses</h3>
                     </div>
            ...
            <section id="overview" className="app-info section">
               <Container fluid="md" style={{
                     ...
                     <Col>
                        <div className="info-image wow fadeInRight position-end" data-wow-delay=".5s">
                           <img className="ss1" src="https://drive.google.com/thumbnail?id=1ApseXmyngSBHI1fSYteqsZ0463m-0L4i" alt=" basic programming"/>
                        </div>
                     </Col>
                     <Col>
                        <div className="info-text wow fadeInLeft text-justify" data-wow-delay=".3s">
                  ...
                  <div className="info-one style2">
                        ...
                        <Col>
                           <div className="info-text wow fadeInRight text-justify" data-wow-delay=".5s">
