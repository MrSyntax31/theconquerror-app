...
<Navbar/>
      ...
      <div className="bg-light"style={{marginTop:'4rem'}}>
         ...
         <section className="our-achievement section">
            ...
            <Row>
               <Col><div className="single-achievement wow fadeInUp" data-wow-delay=".2s">
                              <h3 className="counter"><span id="secondo1" className="countup" cup-end="100">100</span>%</h3>
                              <p>Satisfied</p>
                           </div>
               </Col>

               <Col><h3 className="counter"><span id="secondo2" className="countup" cup-end="100">100</span>%</h3>
                           <p>Free</p></Col>
            </Row>
