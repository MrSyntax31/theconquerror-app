    ...
    return (
        <>
            ...
            <div>
                ...
                <meta name="description" content="Welcome to ConquError User Homepage" />
                </Helmet>
            </div>
                     ...
                     <div className="container h-100">
                        <div className="d-flex h-100 text-center align-items-center">
                           <div className="w-100 text-white">
                              ...
                              <p className="lead mb-0 text-light">Be Part of our Learning Community, Join on our Forums and Enroll on our Courses.</p>
                           </div>
                        </div>
                     </div>
                     ...
                     <Row>          
                        ...
                        <div className="col-sm-4 mb-5">
                           <div className="card mt-4">
                              <img className="card-img-top" src="https://firebasestorage.googleapis.com/v0/b/conquerror-development.appspot.com/o/Homepage%2FProgrammer-rafiki.png?alt=media&token=20d4d570-08d9-40ed-9af7-d31ac42622ba" alt=""/>
                        ...
                        <div className="col-sm-4 mb-5">
                           <div className="card mt-4">
                              <img className="card-img-top" src="https://firebasestorage.googleapis.com/v0/b/conquerror-development.appspot.com/o/Homepage%2FControl%20Panel-rafiki.webp?alt=media&token=3c488bf3-2102-44e1-8d1d-efc4f9eb6109" alt=""/>
                                 <div className="card-body">
               ...
               <section className="our-achievement section">
                  ...
                  <div className="d-flex h-100 text-center align-items-center">
                     ...
                     <h1 className="display-3 text-light">Conquer your Error</h1>
                        <p className="lead mb-0 text-light">A move that can change your life!</p>
                     </div>
                  </div>
                  </div>
                  </header>
                  ...
                  <Container fluid="md" style={{
                     ...
                     <div className="row text-center">
                        ...
                        <div className="col-md-4">
                           <div className="testimonial mb-5">
                              <div className="avatar mx-auto">
                                 <img src="https://firebasestorage.googleapis.com/v0/b/conquerror-development.appspot.com/o/Homepage%2Fuser-06.jpg?alt=media&token=80476a49-633f-482b-8435-b6ba3705c85c" className="rounded-circle z-depth-1 img-fluid" alt="developer"/>
                              </div>
                  ...
                  <FooterStyle className=" pt-10 text-white footer ">
                     ...
                     <div className="container d-flex align-items-center ">
                        ...
                        <h6 className="mt-2 text-white">Follow Us on</h6>
                              <ul className="list-unstyled">
                              <li className="mb-2 text-white"><FaIcons.FaFacebook/> <a href="https://www.facebook.com/theConquErrorph" className="text-decoration-none text-white" target="_blank" rel="noopener noreferrer"> theConquErrorph</a> </li>
                              <li className="mb-2 text-white"><FaIcons.FaYoutube/> <a href="https://www.youtube.com/channel/UCojmF97JXog4ITgDjNtfnqw" className="text-decoration-none text-white" target="_blank" rel="noopener noreferrer"> theConquError</a></li>
                              <li className="mb-2 text-white"><FaIcons.FaDiscord/> <a href="https://discord.gg/CBHw9cAJYS" className="text-decoration-none text-white" target="_blank" rel="noopener noreferrer"> ConquError</a></li>
                              </ul>
                        </div>
                        </div>
