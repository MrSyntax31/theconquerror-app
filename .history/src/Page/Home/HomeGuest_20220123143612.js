    ...
    return (
        <>
            ...
            <div>
                ...
                <meta name="description" content="Welcome to ConquError Guest Homepage" />
                </Helmet>
            </div>
                           ...
                           <div className="col-md-4">
                              <div className="testimonial mb-5">
                                 <div className="avatar mx-auto">
                                    ...
                                    <p className="font-weight-normal dark-grey-text">To achieve your goals as an IT student, you must continue to leverage and expand your knowledge of mission-critical information and telecommunications technology.</p>
                              </div>
                           </div>
