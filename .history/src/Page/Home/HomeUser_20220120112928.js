                  ...
                  <Container fluid="md" style={{
                     ...
                     <div className="row text-center">
                        ...
                        <div className="col-md-4">
                           <div className="testimonial mb-5">
                              <div className="avatar mx-auto">
                                 <img src="https://firebasestorage.googleapis.com/v0/b/conquerror-development.appspot.com/o/Homepage%2Fintel.jpg?alt=media&token=605c2c26-7220-4c28-a34e-f3bea9711d3e" className="rounded-circle z-depth-1 img-fluid" alt="developer"/>
                              </div>
