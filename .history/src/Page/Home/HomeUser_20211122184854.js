...
<Navbar/>
      ...
      <div className="bg-light"style={{marginTop:'4rem'}}>
            ...
            <section id="" className="features section" fluid="md" style={{
                     justifyContent: "center",
                     alignItems: "center"
                  }}>
               <Container fluid="md" style={{
                  ...
                  <Row className="d-flex justify-content-center">
                     ...
                     <Link to="/video" style={{ textDecoration: 'none',marginLeft: '10px', marginTop: '5px' }} className="btn btn-primary w-25"> Show All</Link> 
            </section>
