            ...
            <div className="container">
               <div className="row text-center">
                  ...
                  <div className="col-md-4">
                     <div className="testimonial mb-5">
                        <div className="avatar mx-auto">
                           ...
                           <p className="font-weight-normal dark-grey-text"> is more important than knowledge. Life is like riding a bicycle. To keep your balance you must keep moving. Imagination is everything. It is the preview of life's coming attractions. -Albert Einstein</p>
                     </div>
                  </div>
                  ...
                  <div className="col-md-4">
                     <div className="testimonial mb-5">
                        <div className="avatar mx-auto">
                           <img src="../assets/TJDev.png" className="rounded-circle z-depth-1 img-fluid" alt="developer" style={{
                              
                                 animation: rotate-center 900ms ease-in-out infinite both;
