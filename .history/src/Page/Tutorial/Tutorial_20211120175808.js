                        ...
                        <div className="">
                         ...
                         <Container>
                            <Row>
                                ...
                                <Col sm={8}>
                                <iframe width="1904" height="760" src="https://www.youtube.com/embed/2GeNfPPbvGc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                </Col>
                            </Row>
                            <Row>
                                <Col sm>
                                <iframe width="1904" height="760" src="https://www.youtube.com/embed/2GeNfPPbvGc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen className="responsive-iframe"></iframe>
                                </Col>
                                <Col sm>sm=true</Col>
                                <Col sm>sm=true</Col>
                            </Row>
