                            ...
                            <div className="wide">
                                ...
                                <p><h2>Step-by-step instructional videos on CSS Grid</h2></p>
                                    ...
                                    <div className="container-video">
                                        <div className="vid-title"><Link to="/videos" class="vidlink">Lesson 1 - CSS Grid Basics</Link></div>
                                        
                                        <div className="vid-image">
                                            <a href="videos/lesson1.mp4"><iframe title= "Video1" className="d-flex justify-content-center" width="315" height="315" src="https://www.youtube.com/embed/jcYaWFhV8oY" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen ></iframe></a>
                                        </div>

                                        <div className="vid-desc">This video covers the basics of CSS grid, including grid's properties, a new unit called the "fractional unit" (fr), grid lines, grid areas, nested grids, justification and alignment, overlapping, and making white space.<br/>
                                        <span className="duration">Duration: 1 hour, 10 minutes, 24 seconds</span><br/>
