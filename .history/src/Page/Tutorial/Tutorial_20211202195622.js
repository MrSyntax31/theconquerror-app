                                            ...
                                            <Tab eventKey="profile" title="Home">
                                                <Row>
                                                    ...
                                                    <Col xs={12} md={8} className="container mb-5 m-3">
                                                        ...
                                                        <p className="mt-2 text-justify">
                                                        <strong>How We Started</strong>, Is a small non-profit organization created by a Christian Couple that are creating Programming Tutorials for Filipinos to Watch. All of the knowledge you'll find here is solely from God.</p>
                                                        <label className="fw-bold">Follow and Subscribe to learn more!</label>
                                                        <br/>
