...
import { getFirestore, query, collection, where, limit,  getDocs, doc, orderBy , onSnapshot} from 'firebase/firestore';
...
const collRef = query(collection(docsdb, "docs"),orderBy()));
