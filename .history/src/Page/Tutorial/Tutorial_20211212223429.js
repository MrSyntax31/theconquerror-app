                                                                                    ...
                                                                                    <section className="about_area section_gap mb-3">
                                                                                            <div className="">
                                                                                                <div className="row justify-content-start align-items-center">
                                                                                                    <div className="col-lg-4">
                                                                                                        <div className="about_img">
                                                                                                        <iframe title= "Video1" className="d-flex justify-content-center" width="315" height="315" src="https://youtu.be/WgEXIhkIWZc?list=PLnTAO3B4QEUsch8tj3CWyt2uZiIjaOA-8" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen ></iframe>
                                                                                                        </div>
                                                                                                    </div>

                                                                                                    <div className="offset-lg-1 col-lg-5 mt-3">
                                                                                                        <div className="main_title text-left">
                                                                                                            <h5 className="fw-bold">Tips & Fundamentals of Programming | BSIT | TIPian Student (Tagalog) #JosiahDoesTech</h5>
                                                                                                            <p>
                                                                                                                Today pagaaralan natin magdeclare ng Variables at ang mga Datatypes neto pagaaralan din natin kumuha ng input na galing sa User!
                                                                                                            </p>
                                                                                                            <br/>
