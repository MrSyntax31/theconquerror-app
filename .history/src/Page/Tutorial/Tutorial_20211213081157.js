                                                ...
                                                <div className="offset-lg-1 col-lg-5 mt-3">
                                                    <div className="main_title text-left">
                                                        <h2 className="fw-bold mb-3">let’s <br/>
                                                            ...
                                                            together</h2>
                                                        <p className="mb-3">
                                                            It's easy to study and learn if there someone is willing to help you. People that are willing to help you are called tutors. In this tutorial, you will learn how to become an independent leaner  and understand how to conquer your own problems.
                                                        </p>
                                                        <p> 
                                                            There are a lot of tutorials on the internet, but they are not meant for you. This tutorial is designed to help you understand how to become a better learner.
                                            ...
                                            <section className="about_area section_gap mb-3">
                                                    <div className="">
                                                        <div className="row justify-content-start align-items-center">
                                                            ...
                                                            <div className="offset-lg-1 col-lg-5 mt-3">
                                                                <div className="main_title text-left">
                                                                <h5 className="fw-bold">S2E2 | Bakit Di Umubra ang Work From Home sa Ibang Kumpanya?</h5>
                                                                    <p>
                                            ...
                                            <section className="about_area section_gap mb-3">
                                                    <div className="">
                                                        <div className="row justify-content-start align-items-center">
                                                            ...
                                                            <div className="offset-lg-1 col-lg-5 mt-3">
                                                                <div className="main_title text-left">
                                                                    <h5 className="fw-bold">S2E3 | Career Hack: The More Entries You Send, The More Chances of Winning</h5>
                                                                    <p>
                                            ...
                                            <section className="about_area section_gap mb-3">
                                                    <div className="">
                                                        <div className="row justify-content-start align-items-center">
                                                            ...
                                                            <div className="offset-lg-1 col-lg-5 mt-3">
                                                            <h5 className="fw-bold">S2E4 | College vs. Bootcamp vs. Self-Study: Alin Nga Ba ang Pinaka-Effective?</h5>
                                                                <div className="main_title text-left">
                                                                    <p>
                                            ...
                                            <section className="about_area section_gap mb-3">
                                                    <div className="">
                                                        <div className="row justify-content-start align-items-center">
                                                            ...
                                                            <div className="offset-lg-1 col-lg-5 mt-3">
                                                                <div className="main_title text-left">
                                                                    <h5 className="fw-bold">S2E5 | Should Everyone Invest in Cryptocurrencies?</h5>
                                                                    <p>
