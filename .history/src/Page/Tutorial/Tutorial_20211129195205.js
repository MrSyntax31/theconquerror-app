                                                ...
                                                <Row>
                                                    ...
                                                    <Col xs={12} md={8}>
                                                        ...
                                                        * <i className="fw-bold">"Kuya"</i> means "older brother" in Filipino, often used as a term of endearment.
                                                        ...
                                                        <br/>
                                                        <a href="https://www.facebook.com/Rem.Lampa" className="text-decoration-none text-white" target="_blank" rel="noopener noreferrer"> theConquErrorph<img className="mt-2"style={{width:"50px"}} src="https://img.icons8.com/color/50/000000/facebook-new.png"  alt="facebook" /></a>
                                                        <img className="mt-2"style={{width:"50px"}} src="https://cdn-icons-png.flaticon.com/512/3763/3763359.png"  alt="facebook"/><img src="https://img.icons8.com/color/50/000000/twitter--v2.png"/>
                                                        <img className="mt-2"style={{width:"50px"}} src="https://cdn-icons-png.flaticon.com/512/3763/3763359.png"  alt="facebook"/>
