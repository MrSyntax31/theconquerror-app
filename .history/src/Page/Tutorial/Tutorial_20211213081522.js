                                                ...
                                                <div className="offset-lg-1 col-lg-5 mt-3">
                                                    <div className="main_title text-left">
                                                        <h2 className="fw-bold mb-3">let’s <br/>
                                                            ...
                                                            together</h2>
                                                        <p className="mb-3">
                                                            It's easy to study and learn if there is someone willing to help you. People that are willing to help you are called tutors. In these tutorial, you will learn how to become an independent leaner  and understand how to conquer your own problems.
                                                        </p>
                                                        <p> 
