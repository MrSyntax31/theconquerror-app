                ...
                <section className="features section bg-light mt-4">
                        ...
                        <Container>
                            ...
                            <Card className="mt-5">
                                                    <Row>
                                                        <Col  className="text-center">
                                                                    <img alt="KuyaDev" variant="top" className="mt-5 w-50" src="https://firebasestorage.googleapis.com/v0/b/conquerror-development.appspot.com/o/Images%2FCreator%2F162108690_121301806677028_8488807075884298821_n.jpg?alt=media&token=7ea53e45-dee7-4a61-bb98-407b21d24f94" />
                                                                <div className="text-center mt-3">
                                                                    <p><strong>Kuya Dev</strong></p>
                                                                    <p>Ako si Rem, ang inyong Kuya Dev.</p>
                                                                </div>
