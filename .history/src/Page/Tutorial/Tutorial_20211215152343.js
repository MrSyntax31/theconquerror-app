                                ...
                                <Container>
                                        ...
                                        <Tabs defaultActiveKey="profile" id="uncontrolled-tab-example" className="mb-3 p-2 m-2">
                                            <Tab eventKey="profile" title="Josiahdoestech">
                                                <Row>
                                                    <Col  className="text-center m-3">
                                                                <img alt="KuyaDev" variant="top" className="mt-2 w-50" src="oQ_wAX8RHzGB&_nc_oc=AQlVZUD5CQRJFH1xQVedfBzhvSmcrBwJU0c9jj-LM2AE6rgvIycf03sE38Hl9BROKo8&_nc_ht=scontent.fmnl9-1.fna&oh=06ac953b4ad7d0423bd2772b0e0da1da&oe=61B926EC" />
                                                            <div className="text-center">
