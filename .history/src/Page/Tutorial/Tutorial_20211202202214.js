                                                    ...
                                                    <Row>
                                                        ...
                                                        <Col xs={12} md={8} className="container mb-5 m-3">
                                                            ...
                                                            * <i className="fw-bold">"Kuya"</i> means "older brother" in Filipino, often used as a term of endearment.
                                                            ...
                                                            <br/>
                                                            <h5>
                                                            <Badge text="dark"><BsIcons.BsTags/> Career Hack</Badge>
                                                            <Badge text="dark"><BsIcons.BsTags/> Podcast</Badge>
                                                            <Badge text="dark"><BsIcons.BsTags/> IT Tips</Badge>
                                                            <Badge text="dark"><BsIcons.BsTags/> GraphQL</Badge>
                                                            </h5>
                                                ...
                                                <Row>
                                                    ...
                                                    <Col xs={12} md={8} className="container mb-5 m-3">
                                                        ...
                                                        <br/>
                                                            <h5>
                                                            <Badge text="dark"><BsIcons.BsTags/> IT Tips</Badge>
                                                            <Badge text="dark"><BsIcons.BsTags/> C++ Tutorial</Badge>
                                                            <Badge text="dark"><BsIcons.BsTags/> Programming</Badge>
                                                            <Badge text="dark"><BsIcons.BsTags/> Basic Web</Badge>
                                                            </h5>
