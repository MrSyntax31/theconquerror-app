                                                    ...
                                                    <Row>
                                                        ...
                                                        <Col xs={12} md={8} className="container mb-5 m-3">
                                                            ...
                                                            * <i className="fw-bold">"Kuya"</i> means "older brother" in Filipino, often used as a term of endearment.
                                                            ...
                                                            <br/>
                                                            <h5>
                                                            <Badge variant="outline-light"><BsIcons.BsTags/> Career Hack</Badge>
                                                            <Badge variant="outline-primary"><BsIcons.BsTags/> Podcast</Badge>
                                                            <Badge variant="outline-primary"><BsIcons.BsTags/> IT Tips</Badge>
                                                            <Badge variant="outline-primary"><BsIcons.BsTags/> GraphQL</Badge>
                                                            </h5>
                                                            <br/>
