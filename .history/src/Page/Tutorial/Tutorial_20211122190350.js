                        ...
                        <div className="">
                         ...
                         <Container fluid="md" style={{
                                ...
                                <Row className="d-flex justify-content-center">
                                    ...
                                    <h4 className="text-center text-secondary">Basic Programming Course</h4>
                                    <div className="d-flex justify-content-center" data-wow-delay=".4s">
                                        <iframe title= "Video1" className="d-flex justify-content-center" width="720" height="315" src="https://www.youtube.com/embed/jcYaWFhV8oY" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen ></iframe>
                                    </div>
                                    </div>
