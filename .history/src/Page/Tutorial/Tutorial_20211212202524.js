                                                    ...
                                                    <div className="offset-lg-1 col-lg-5 mt-3">
                                                        <div className="main_title text-left">
                                                            ...
                                                            <span className="duration">Duration: 1 hour, 10 minutes, 24 seconds</span><br/>
                                                                Watch: <a href="videos/lesson1.mp4" className="vidlink">MP4</a> | <a href="https://youtu.be/_32SK2o35sI" className="vidlink">YouTube</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="">
                                                <div className="row justify-content-start align-items-center">
                                                    <div className="col-lg-4">
                                                        ...
                                                        <iframe width="1904" height="760" src="https://www.youtube.com/embed/z2xadp8e9Xs?list=PLh6-IXduASC_QtCU7Dnn3IdLyhsshNtEv" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                                        </div>
                                                    </div>
