                                                                                                ...
                                                                                                <div className="row justify-content-start align-items-center">
                                                                                                    ...
                                                                                                    <div className="offset-lg-1 col-lg-5 mt-3">
                                                                                                        ...
                                                                                                        <h5 className="fw-bold">A day in the life of a BSIT student |First day of online classes | online learning #josiahdoestech</h5>
                                                                                                            ...
                                                                                                            <p>
                                                                                                            Hello everyone! As we all know, I am now an affiliate with StyleDoubler where you can have commissions to the purchases on online Shopping like Lazada! If you would like to support me in my journey, you can help me with these links of what is in my setup! Thanks everyone!
Ryzen 5 3600
                                                                                                            </p>
                                                                                                            <br/>
