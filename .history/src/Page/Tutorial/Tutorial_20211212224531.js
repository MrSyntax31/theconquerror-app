                                                                                                ...
                                                                                                <div className="row justify-content-start align-items-center">
                                                                                                    ...
                                                                                                    <div className="offset-lg-1 col-lg-5 mt-3">
                                                                                                        ...
                                                                                                        <h5 className="fw-bold">A day in the life of a BSIT student |First day of online classes | online learning #josiahdoestech</h5>
                                                                                                            <p>
                                                                                                            Hello everyone! sorry for not posting so much lately I've veen busy with my school and organization activities!  but here yah go! here's my daily routine as a BsIT student! don't forget to leave a like to this video and don't forget to subscribe!  God bless everyone and stay safe!
                                                                                                            </p>
