                                                                                    ...
                                                                                    <section className="about_area section_gap mb-3">
                                                                                            <div className="">
                                                                                                <div className="row justify-content-start align-items-center">
                                                                                                    <div className="col-lg-4">
                                                                                                        <div className="about_img">
                                                                                                            <iframe title= "Video1" className="d-flex justify-content-center" width="315" height="315" src="https://youtube.com/embedediSNeOTyPALY?list=PLnTAO3B4QEUsch8tj3CWyt2uZiIjaOA-8" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen ></iframe>
                                                                                                        </div>
                                                                                                    </div>
