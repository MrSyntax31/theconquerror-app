                                                                                                ...
                                                                                                <div className="row justify-content-start align-items-center">
                                                                                                    ...
                                                                                                    <div className="offset-lg-1 col-lg-5 mt-3">
                                                                                                        ...
                                                                                                        <h5 className="fw-bold">C++ Tutorial #1: IDE and Hello World | Filipino | Tagalog</h5>
                                                                                                            ...
                                                                                                            <br/>
                                                                                                            <span className="duration">Duration: 10 minutes, 020 seconds</span><br/>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                                    ...
                                                                                                    <h5 className="fw-bold">C++ Tutorial #3: Arrays | Filipino | Tagalog</h5>
                                                                                                        <div className="main_title text-left">
                                                                                                            ...
                                                                                                            Today we will be learning about arrays and how to manipulate them.
                                                                                                               ...
                                                                                                               <br/>
                                                                                                            <span className="duration">Duration: 10 minutes, 56 seconds</span><br/>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                                ...
                                                                                                <div className="row justify-content-start align-items-center">
                                                                                                    <div className="col-lg-4">
                                                                                                        <div className="about_img">
                                                                                                            ...
                                                                                                            <iframe width="1904" height="760" src="https://www.youtube.com/embed/7ltB_Hfegzs?list=PLVnJhHoKgEmrAk6XdaioMlfmpD_ahnA-B" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                                                                                        </div>
                                                                                                    </div>
