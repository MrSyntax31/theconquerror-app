                        ...
                        <div>
                            ...
                            <section className="features section bg-light mt-5">
                                <section fluid="md" style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                                    <Row>
                                        <div className="">
                                            <h3 className="text-center text-primary fw-bold">Our featured Content Creators</h3>
                                        </div>
                                                ...
                                                <Tab eventKey="home" title="Kuya Dev">
                                                    <Row>
                                                        <Col  className="text-center">
                                                                    <img alt="KuyaDev" variant="top" className="mt-2 w-25" src="https://firebasestorage.googleapis.com/v0/b/conquerror-development.appspot.com/o/Images%2FCreator%2F162108690_121301806677028_8488807075884298821_n.jpg?alt=media&token=7ea53e45-dee7-4a61-bb98-407b21d24f94" />
                                ...
                                <section className="m-2">
                                        ...
                                        <Tabs defaultActiveKey="profile" id="uncontrolled-tab-example" className="mb-3 p-2 m-2">
                                            <Tab eventKey="profile" title="Josiahdoestech">
                                                <Row>
                                                    <Col  className="text-center m-3">
                                                                <img alt="Josiahdoestech" variant="top" className="mt-2 w-25" src="https://firebasestorage.googleapis.com/v0/b/conquerror-development.appspot.com/o/Homepage%2FJoshiah.jpg?alt=media&token=4c038b0b-f016-4088-a3b9-2ebca0bf5bc1" />
                                                            <div className="text-center mt-3">
                                ...
                                <section className="m-2">
                                        ...
                                        <Tabs defaultActiveKey="profile" id="uncontrolled-tab-example" className="mb-3 p-2 m-2">
                                            <Tab eventKey="profile" title="John Carlo Franco">
                                                <Row>
                                                    <Col  className="text-center m-3">
                                                                <img alt="John Carlo Franco" variant="top" className="mt-2 w-25" src="https://firebasestorage.googleapis.com/v0/b/conquerror-development.appspot.com/o/Images%2FCreator%2F149870072_4438803116146821_814614453010169425_n.jpg?alt=media&token=bb9aa651-9f9d-4b9c-bca7-420d7125bc76" />
                                                            <div className="text-center  mt-3">
                        ...
                        <section>
                            <Card className="mt-2">
                                <Card.Header className="text-center">
                                    ...
                                    <p>
                                    You may need specific softwares to open, view and print the files in this page: Microsoft Excel Online or Microsoft Word Online. Most modern browsers and devices can open PDF and ZIP files.
                                    </p>
                                </Card.Header>
                                <Card.Body>
                                            <Form>
