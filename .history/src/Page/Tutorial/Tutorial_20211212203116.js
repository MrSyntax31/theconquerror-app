                                                ...
                                                <div className="row justify-content-start align-items-center">
                                                    ...
                                                    <div className="offset-lg-1 col-lg-5 mt-3">
                                                        <div className="main_title text-left">
                                                            ...
                                                            <span className="duration">Duration: 13 minutes, 38 seconds</span><br/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="">
                                                <div className="row justify-content-start align-items-center">
                                                    <div className="col-lg-4">
                                                        ...
                                                        <iframe width="1904" height="760" src="https://www.youtube.com/embed/rMiDze5Nguc?list=PLh6-IXduASC_QtCU7Dnn3IdLyhsshNtEv" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                                        </div>
                                                    </div>
