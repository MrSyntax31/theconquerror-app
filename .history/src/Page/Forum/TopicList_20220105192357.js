                              ...
                              <h3 className="fw-bold fs-m text-start container mb-3"><GoIcons.GoCommentDiscussion/> All Topics </h3>
                                ...
                                <Offcanvas show={shows} onHide={handleClosed}>
                                  ...
                                    <label htmlFor="Function" className="form-check-label">Function</label>
                                    ...
                                    <strong>Filter Solved:</strong><br></br>
                                    <div className="form-check">
                                        <input type="radio" id="If Else Condition" name="Programming"  className="form-check-input" onClick={handleChangeTagSolved} value="unsolved"/>
                                        <label htmlFor="Unsolved" className="form-check-label">Unsolved</label>
                                    </div>
                                    <div className="form-check">
                                        <input type="radio" id="Solved" name="Programming"  className="form-check-input" onClick={handleChangeTagSolved} value="Solved"/>
                                        <label htmlFor="Solved" className="form-check-label">Solved</label>
                                    </div>
