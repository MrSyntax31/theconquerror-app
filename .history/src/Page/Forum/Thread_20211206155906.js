...
const Thread = () => {
   ...
   async function addComment(){
    ...
    return <div className="commentSection">
        ...
        <img className="mx-auto d-block img-fluid mt-3 mb-3" style={{width: '25%', height: 'auto'}} src={topic.sampcodeimg} alt={topic.title} /> 
        {showRep}
                        ...
                        <Row>
                            <Col l="auto">
                                ...
                                <div className="d-flex">
                                    <input type="textarea"  value={reply || ''} onChange={e => setReply(e.target.value)} className=" form-control w-100"/>
                                </div>
                                <div className="NoUserMenu position-absolute top-50 end-0 translate-middle-y">
                                    <button type="button" onClick={addComment} className="btn btn-primary mt-2 ">Add Comment</button>  
                                </div>
                            </Col>
