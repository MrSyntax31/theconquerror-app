    ...
    getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
      ...
      function onLoad() {
        ...
        const showProfile = function(e) {
          ...
          setLevel(e.target.getAttribute("data-lvl"));
        ...
        <p>Uploaded by: <label className="text-primary" data-id ={topic.id} data-lvl ={topic.userlvl} onClick={ showProfile }>{topic.created_by}</label> on <strong>
                              ...
                              <Modal size="sm" show={smShow}  onHide={() => setSmShow(false)}  aria-labelledby="example-modal-sizes-title-sm">
                                ...
                                <Modal.Body>
                                    <div className="text-center">
                                      <img src={avatar.img} className="rounded-circle" alt="UserLvl" width="100" height="100"/><</nr>br></br>
                                      <strong>Email</strong>
