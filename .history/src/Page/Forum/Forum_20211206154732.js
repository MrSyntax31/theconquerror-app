              ...
              <Modal show={show} onHide={handleClose} backdrop="static" keyboard={false} >
                ...
                {error && <Alert variant="danger">{error}</Alert>}
                    ...
                    <Container>
                      ...
                        <label for="Function" className="form-check-label">Array</label>
                        </div>
                        <div className="form-check">
                            <input type="radio" id="C++" name="Programming" value="  className="form-check-input" onChange={handleChange}/>
                            <label for="C" className="form-check-label">C++</label>
                        </div>
                        <div className="form-check">
                            <input type="radio" id="CodeBlocks" name="Programming" value="CodeBlocks" className="form-check-input" onChange={handleChange}/>
