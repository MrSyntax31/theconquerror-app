...
uploadTask.on('state_changed',
  ...
  () => {
    ...
    getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
      ...
      const [showUserProfile, setUserProfile] = useState([]);
      ...
      function onLoad() {
        ...
        onSnapshot(doc(forumdb, "warrioravatar", level), (doc) => {
        ...
        const showProfile = function(e) {
          ...
          onSnapshot(doc(forumdb, "topics", dataid), (doc) => {
            const docdata = (doc.data())
        ...
        <p>Uploaded by: <label className="text-primary" data-id ={topic.id} onClick={ showProfile }>{topic.created_by}</label> on <strong>
                              ...
                              <Modal size="sm" show={smShow}  onHide={() => setSmShow(false)}  aria-labelledby="example-modal-sizes-title-sm">
                                ...
                                <Modal.Body>
                                    <div className="text-center">
                                      <img src="https://img.icons8.com/external-wanicon-flat-wanicon/64/000000/external-knight-fairytale-wanicon-flat-wanicon.png" className="rounded-circle" alt="UserLvl" width="100" height="100"/>
                                      <h6>{showUserProfile.created_by}</h6>
                                    </div>
                                    <div className="text-center">
                                      <h5>{showUserProfile.userlvl}</h5>
                                    </div>
