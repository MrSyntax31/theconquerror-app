...
const Thread = () => {
   ...
   async function addComment(){
    ...
    return <div className="commentSection">
        ...
        <img className="mx-auto d-block img-fluid mt-3 mb-3" style={{width: '25%', height: 'auto'}} src={topic.sampcodeimg} alt={topic.title} onclick="enlargeImg(this)"/> 

        <GlassMagnifier
  imageSrc={topic.sampcodeimg}
  imageAlt="Example"
  largeImageSrc={topic.sampcodeimg} // Optional
/>
