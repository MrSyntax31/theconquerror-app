                        ...
                        <Row>
                            <Col l="auto">
                                ...
                                <div className="d-flex">
                                 {closed &&   <input type="textarea"  value={reply || ''} onChange={e => setReply(e.target.value)} className="form-control w-100 m-1"/>   <button type="button" onClick={addComment} className="btn btn-primary m-1 text-right pull-right">Reply</button> } 
