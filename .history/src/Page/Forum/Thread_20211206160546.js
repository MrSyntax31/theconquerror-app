                        ...
                        <Row>
                            <Col l="auto">
                                ...
                                <div className="d-flex">
                                    <input type="textarea"  value={reply || ''} onChange={e => setReply(e.target.value)} className="form-control w-100 ml-2"/>
                                    <button type="button" onClick={addComment} className="btn btn-primary text-right pull-right">Reply</button>  
                                </div>
