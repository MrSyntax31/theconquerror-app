    ...
    getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
     ...
     charactersLength));
       ...
       return result;
        ...
        <p>Uploaded by: <label className="text-primary" style={{cursor:"pointer"}} data-id ={topic.created_by} data-lvl ={topic.userlvl} onClick={ showProfile }>{topic.created_by}<Badge bg="primary">{topic.case_status}</Badge></label> on <strong>
