...
uploadTask.on('state_changed',
  ...
  () => {
    ...
    getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
      ...
      <p>Uploaded by: <strong className="text-primary" onClick={ handleShowP }>{topic.created_by}</strong> on <strong>
        ...
        <div>
            ...
            {/* Container for Search and Ask Question*/}
              ...
              <Modal show={showP} onHide={handleCloseP}>
                ...
                <Modal.Body>
                      <div className="text-center">                                  <img src="" className="rounded-circle" alt="UserLvl" width="100" height="100"/>
                       </div>
