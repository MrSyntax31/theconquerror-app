...
<img className="mx-auto d-block img-fluid mt-3 mb-3 image-preview image-preview-js" src={topic.sampcodeimg} alt="Snow" style={{width:'100%' }} onClick={enlargeImage}></img>
