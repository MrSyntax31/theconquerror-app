...
const Thread = () => {
   ...
   async function addComment(){
        ...
        if (user === null){
            ...
            if (window.
                swal({type: 'error', title: 'You need to be logged in to comment', text: 'Please login to comment'})){
                swal('You need to be logged-in to continue, Press Yes to Proceed to our Log-in Page')) {
                // Save it!
               history.push("/login")
              } else {
                    //nothing
