  ...
  () => {
    ...
    getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
      ...
      async function addNew(){
        ...
        const Discussion= topics.map((topic) => (  <div className="Discussion-Board p-3 border border-primary rounded" key={topic.id} > 
  ...
  return (
            ...
            <div fluid="md" style={{
                ...
                <Container className="text-center mt-5 mb-5 container">
                  <div>
                      <h1 className="text-center text-primary fw-bold">ConquErroRoom</h1>                                   
