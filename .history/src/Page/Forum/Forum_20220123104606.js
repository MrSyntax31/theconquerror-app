...
import {  Nav, Navbar, Modal, Button,  ProgressBar, Alert, Badge, OverlayTrigger, Tooltip } from 'react-bootstrap';
...
uploadTask.on('state_changed',
  ...
  return (
            ...
            <Navbar bg="secondary" variant="secondary" fixed="top" expand="sm" collapseOnSelect className="" style={{marginTop:'6rem'}}>
        <Navbar.Brand>
