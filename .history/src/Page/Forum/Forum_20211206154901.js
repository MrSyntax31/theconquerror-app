                ...
                {error && <Alert variant="danger">{error}</Alert>}
                    ...
                    <Container>
                      ...
                        <label for="Function" className="form-check-label">Function</label>
                        ...
                        <div className="form-check">
                            <input type="radio" id="CodeBlocks" name="Programming" value="For loops" className="form-check-input" onChange={handleChange}/>
                            <label for="CodeBlocks" className="form-check-label">For loops</label>
                        </div>
                        </Col>
                      </Row>
                    </Container>
