    ...
    return <div className="commentSection">
        ...
        <Dropdown>
            ...
            <Dropdown.Menu>
                ...
                <Dropdown.Item onClick={DeletePost}>Case Close</Dropdown.Item>
            </Dropdown.Menu>
        </Dropdown>
    </div>
    }
                        ...
                        <Row>
                            <Col l="auto">
                                ...
                                <div className="d-flex">
                                  <input type="textarea"  value={reply || ''} disabled={closed}  onChange={e => setReply(e.target.value)} className="form-control w-100 m-1"/>
                                    <button type="button" disabled={closed} onClick={addComment} className="btn btn-primary m-1 text-right pull-right">Reply</button>   
                                </div>
