...
import { getFirestore, collection, onSnapshot, query, orderBy, startAfter, limit, getDocs, doc,setDoc, endBefore, limitToLast, where } from 'firebase/firestore';
        ...
        event.preventDefault();
           ...
           async function getMore(){
            ...
            async function goBack(){
              ...
              swal("Sorry","There are no more Data left to show you, you will now be redirected","warning")
              history.push("/alltopics")
            }
