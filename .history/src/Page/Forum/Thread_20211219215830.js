...
<img className="mx-auto d-block img-fluid mt-3 mb-3 image-preview image-preview-js"  alt="Snow" style={{width: '25%', height: 'auto'}} src={topic.sampcodeimg} alt="sample" onClick={enlargeImage}/>

<div id="myModal" class="modal">
 
<span className="close" onClick={close}>&times;</span>

<img className="mx-auto d-block img-fluid mt-3 mb-3 image-preview image-preview-js"  alt="Snow" style={{width: '25%', height: 'auto'}} src={topic.sampcodeimg} alt="sample1" onClick={enlargeImage}/>
