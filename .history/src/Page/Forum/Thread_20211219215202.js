...
<img id="myImg" src={topic.sampcodeimg} alt="Snow" style={{width:'100%' }} onClick={enlargeImage}></img>


<div id="myModal" class="modal">

 
  <span classclassName="close" onClick={close}>&times;</span>

  <img  id="img01" alt="img"> </img>
