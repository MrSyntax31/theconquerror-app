...
const Thread = () => {
   ...
   async function addComment(){
    ...
    return <div className="commentSection">
        ...
        <figure class="Magnify js-magnify" data-controller="magnify">
            <div class="Magnify-glass js-magnifyGlass"></div>
            <img class="Magnify-image js-magnifyImage" src="https://source.unsplash.com/category/nature" alt="img"/>
        </figure>
        </div>
        {showRep}
