                        ...
                        <Row>
                            <Col l="auto">
                                ...
                                <div className="d-flex">
                                    <input type="textarea"  value={reply || ''} onChange={e => setReply(e.target.value)} className="mt-2 form-control w-100"/>
                                </div>
                            </Col>

                            <Col sm lg="2">
                                <div className="NoUserMenu mt-5 ">
                                    <button type="button" onClick={addComment} className="btn btn-primary mt-3">Add Comment</button>  
                                </div>
                            </Col>
                        </Row>
                    </Form>
