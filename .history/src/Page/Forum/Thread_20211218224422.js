   ...
   async function addComment(){
    ...
    return <div className="commentSection">
        ...
        <div className="border border-primary mt-3">
            { topic.sampcodeimg &&  <img className="mx-auto d-block img-fluid mt-3 mb-3 image-preview image-preview-js" style={{width: '25%', height: 'auto'}} src={topic.sampcodeimg} alt={topic.title} onclick="enlargeImg(this)"/>  }
