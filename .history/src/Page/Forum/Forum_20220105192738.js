...
import {  Modal, Button,  ProgressBar, Alert, adge } from 'react-bootstrap';
    ...
    getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
     ...
     charactersLength));
       ...
       return result;
        ...
        <p>Uploaded by: <label className="text-primary" style={{cursor:"pointer"}} data-id ={topic.created_by} data-lvl ={topic.userlvl} onClick={ showProfile }>{topic.created_by}<Badge bg="secondary">Secondary</Badge></label> on <strong>
