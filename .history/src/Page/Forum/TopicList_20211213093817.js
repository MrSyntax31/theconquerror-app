               ...
               {/* Modal for Ask Question*/}
                ...
                {error && <Alert variant="danger">{error}</Alert>}
                    ...
                    <Form noValidate validated={validated} className="">
                                  ...
                                  <Form.Group id="Question" className="mb-3">
                                    <Form.Label>Question</Form.Label>
                                    <Form.Control  value={description || ''} onChange={e => setDesc(e.target.value)} name = "text" type="text" required  placeholder="Title"/>
                                  </Form.Group>
                    <textarea type="text" className="form-control mb-3" required></textarea>
