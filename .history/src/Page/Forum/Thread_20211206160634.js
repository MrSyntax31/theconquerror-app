                        ...
                        <Row>
                            <Col l="auto">
                                ...
                                <div className="d-flex">
                                    <input type="textarea"  value={reply || ''} onChange={e => setReply(e.target.value)} className="form-control w-100 m-2"/>
                                    <button type="button" onClick={addComment} className="btn btn-primary m-2 text-right pull-right">Reply</button>  
                                </div>
