  ...
  () => {
    ...
    getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
      ...
      function onLoad() {
        ...
        <p>Uploaded by: <label className="text-primary" data-id ={topic.cre} data-lvl ={topic.userlvl} onClick={ showProfile }>{topic.created_by}</label> on <strong>
