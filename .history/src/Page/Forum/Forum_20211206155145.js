                ...
                {error && <Alert variant="danger">{error}</Alert>}
                    ...
                    <Container>
                      ...
                        <label for="Function" className="form-check-label">Function</label>
                        ...
                        <div className="form-check">
                            <input type="radio" id="SyntaxesSyntaxes" name="Programming" value="Syntaxes" className="form-check-input" onChange={handleChange}/>
                            <label for="Syntaxes" className="form-check-label">Syntaxes</label>
                        </div>
                        <div className="form-check">
                            <input type="radio" id="SyntaxesSyntaxes" name="Programming" value="If Else Condition" className="form-check-input" onChange={handleChange}/>
                            <label for="Syntaxes" className="form-check-label">If Else Condition</label>
                        </div>
                        </Col>
                      </Row>
                    </Container>
