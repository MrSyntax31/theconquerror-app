...
const Thread = () => {
   ...
   async function addComment(){
    ...
    return <div className="commentSection">
        ...
        <img className="mx-auto d-block img-fluid mt-3 mb-3 image-preview image-preview-js" style={{width: '50%', height: 'auto'}} src={topic.sampcodeimg} alt={topic.title} onclick="enlargeImg(this)"/> 
        </div>
        {showRep}
