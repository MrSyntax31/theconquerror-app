...
import { getFirestore, collection, onSnapshot, query, orderBy, startAfter, limit, getDocs, doc,setDoc, where, isEqualTo } from 'firebase/firestore';
...
export default function TopicList() {
        ...
        const tagQ = query(collection(forumdb, "topics"), where("case_status", "==", "solved"));

        async function test123(){

          const docSnap = await getDoc(tagQ);
