    ...
    return (
        <div>
            ...
            <Container className="mt-3">
                      ...
                      <input type="radio" id="Option1" name="Quiz" className="form-check-input" onClick={} value={quiz.Opt1Wrong} />
                      <label htmlFor="Option1" className="form-check-label">Array</label>
                      </div>
                      <div className="form-check">
                          <input type="radio" id="Option2" name="Quiz"  className="form-check-input" onClick={} value={quiz.Opt2Correct} />
