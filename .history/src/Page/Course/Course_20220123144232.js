...
const Course = () => {
    ...
    return (
        ...
        <div>
            ...
            <meta name="description" content="Welcome to ConquError Course page. Select your course to continue." />
            </Helmet>
        </div>
        ...
        <section className=" section mt-5">
          ...
          <Container fluid="md" style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
              ...
              <Row>
                  ...
                  <div>
                    <h2 className="text-center text-primary fw-bold">Welcome to the Courses Section</h2>
                    <h3 className="text-center text-secondary fw-bold"> Experience new and better ways to learn computer programming</h3>
                  </div>
