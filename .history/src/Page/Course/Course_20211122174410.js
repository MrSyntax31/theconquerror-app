...
import { Button, Row, Container, Col, Text } from 'react-bootstrap';
            ...
            <Col className="text-center text-secondary">
              <div className="">
                  ...
                  <h4 className="text-center text-secondary"> Experience new and better way to learn programming</h4>
                    ...
                    <Row>
                          <Text className="mt-4 mb-5 text-center">
                                    ...
                                    computer programming, from concepts, methods, functions, and many more.</Text>
                    </Row>   
                          {showCourse}     
            </Row>  
          </Container>
