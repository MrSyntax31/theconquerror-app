                    ...
                      <label htmlFor="Option1" className="form-check-label">{quiz.Opt1Wrong}</label>
                      ...
                      <div class="container mt-sm-5 my-1">
                        <div class="question ml-sm-5 pl-sm-5 pt-2">
                            ...
                            <input type="radio" id="Option1" name="Quiz" className="form-check-input" onChange={e => chooseAnswer(e.target.value)} value={quiz.Opt1Wrong} /><span class="checkmark"></span>
                            <label htmlFor="Option1" className="form-check-label options">{quiz.Opt1Wrong}</label>
