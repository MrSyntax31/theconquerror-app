...
const Lessons = () => {
  ...
  const enroll = async function(e){
    ...
    <h2 className="text-primary" style={{borderRadius: "50%",  width: "34px", height: "34px", backgroundColor: "primary", color: "black", textAlign: "center", fontSize: "20px", fontWeight: "bold", marginBottom: "10px"}}>{courses.Difficulty}</h2>
