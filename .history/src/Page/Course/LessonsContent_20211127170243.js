...
const popover = (
  <Popover id="popover-basic">
    ...
    <div className="sidenav">
      <p></p>
      <Link to="/lessons" style={{ textDecoration: 'none'}} data-toggle="tooltip" data-placement="top" title="Overview"><FaIcons.FaArrowCircleLeft/></Link>
                          ...
                          <Card.Body>
                            ...
                            <section id="vid">
                              <Container>
                                    <Row>
                                      <Col sm={4}>
                                                          <label className="fw-bold text-primary mt-5">Introduction Video</label>
