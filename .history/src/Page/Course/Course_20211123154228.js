          ...
          alignItems: "center"
                ...
                alignItems: "center"}}>
                        <Card style={{ width: '18rem', marginTop: '2rem' }}>
                                    ...
                                    <Card.Body>
                                      ...
                                      <Link to="/course" style={{ textDecoration: 'none' }} className="btn btn-primary mb-4">Get Started</Link>
                                    </Card.Body>
                                  </Card>        
             </Col>
             <Col style={{width: "200px",
             ...
             <Card style={{ width: '18rem', marginTop: '2rem' }}>
                                    ...
                                    <Card.Body>
                                      ...
                                      <Button style={{ textDecoration: 'none' }} className="btn btn-primary mb-4">Level Up</Button>
                                    </Card.Body>
                                  </Card>
             </Col>
            </Row>  
