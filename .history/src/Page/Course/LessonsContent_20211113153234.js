...
<div className="" style={{marginTop:'5rem',  marginBottom:'3rem'}}>
      ...
      <Link to="/course" style={{ textDecoration: 'none', marginLeft:'1rem' }} className="btn btn-primary mb-4">Back</Link>
            ...
            <Card className="m-5">
                <Card.Header><AiIcons.AiFillCode/> {lessonid} {courses.Title}</Card.Header>
                  <Card.Body>
                  
                      <Card.Title className="mt-3 text-center"> </Card.Title>
                      <Card.Text>
                      <Row>
                        <Col>
                        <img height="200" width="200" src={courses.Image} alt={courses.Title} className="mx-auto d-block"/>
                        </Col>
                        <Col xs={6} className="mt-3  text-justify">
