                            ...
                            <section id="content" className="mt-5">
                              <Container>                                
                                ...
                                <div>
                                  ...
                                  <code>{courseinfo.ncscode1}</code>{courseinfo.ncscontent11}
                                  <code>{courseinfo.ncscode2}</code>
                                  <code>{courseinfo.ncscode3}</code>
                                  <code>{courseinfo.ncscode4}</code>
                                  <code>{courseinfo.ncscode5}</code>
                                  <code>{courseinfo.ncscode6}</code>{courseinfo.ncscontent11}
                                  <code>{courseinfo.ncscode7}</code>
