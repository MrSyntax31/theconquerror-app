                          ...
                          <Card.Body>
                            ...
                            <section id="content" className="mt-5">
                              <Container>                                
                                ...
                                <br/>
                                <label className="fw-bold mb-3">{courseinfo.title2}</label>  
                                ...
                                <br/>
                                <label className="fw-bold mb-3">{courseinfo.title3}</label> 
                                ...
                                <a href={courseinfo.pclink1} >See AplusTopper</a>

                                <br/>
                                <label className="fw-bold mb-3 mt-3">{courseinfo.title4}</label>
                                <p>{courseinfo.content22}</p>
                                <p>{courseinfo.content23}</p>
                                <img className="mx-auto d-block mt-3 mb-3" style={{width: '50%', height: 'auto'}} src={courseinfo.pcimage1} alt={courses.Title} />
                                <p className="text-center font-italic">{courseinfo.pccaption1}</p>

                                <br/>
                                <p>{courseinfo.content24}</p>
                                <img className="mx-auto d-block mt-3 mb-3" style={{width: '50%', height: 'auto'}} src={courseinfo.pcimage2} alt={courses.Title} />
                                <p className="text-center font-italic">{courseinfo.pccaption2}</p>

                                <p>{courseinfo.content25}</p>
                                <img className="mx-auto d-block mt-3 mb-3" style={{width: '50%', height: 'auto'}} src={courseinfo.pcimage3} alt={courses.Title} />
                                <p className="text-center font-italic">{courseinfo.pccaption3}</p>

                                <p>{courseinfo.content26}</p>
                                <img className="mx-auto d-block mt-3 mb-3" style={{width: '50%', height: 'auto'}} src={courseinfo.pcimage4} alt={courses.Title} />
                                <p className="text-center font-italic">{courseinfo.pccaption4}</p>
                                
                                <h3 className="fw-bold mb-3 mt-3">{courseinfo.title6}</h3>
