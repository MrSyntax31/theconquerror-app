  ...
  <div key={courses1.id} className="card mb-5">
    ...
    return (
        ...
        {/* Helmet */}
            <div>
              <Helmet>
                ...
                <meta name="description" content="Welcome to the ConquError Lessons Program. Learn more about your favorite topics and lessons." />
              </Helmet>
            </div>  
      ...
      <section className="headNav">
            <div style={{marginTop: '5rem' }} className="mb-4 mx-auto d-block">
             
           
                  <br/>
                    <a href="#intro" data-toggle="tooltip" data-placement="top" title="Course" className="text-light" style={{textDecoration: 'none'}}><ImIcons.ImFileText/> Overview</a>{' '}
                    <a href="#vid" data-toggle="tooltip" data-placement="top" title="Introductory Video" className="text-light" style={{textDecoration: 'none'}}><FaIcons.FaVideo/> Introduction</a>{' '}
                    <a href="#content" data-toggle="tooltip" data-placement="top" title="Lesson Content" className="text-light" style={{textDecoration: 'none'}}><GiIcons.GiNotebook/> Lessons</a>{' '}
                    <a href="#code" data-toggle="tooltip" data-placement="top" title="Sample Code" className="text-light" style={{textDecoration: 'none'}}><AiIcons.AiFillCode/> Sample Code</a>{' '}
                    <a href="#assess" data-toggle="tooltip" data-placement="top" title="Assessment" className="text-light" style={{textDecoration: 'none'}}><MdIcons.MdQuiz/> Assessment</a>{' '}
            </div>
       </section>

      <div fluid="md" className="mb-5" style={{ display: "flex", justifyContent: "center", alignItems: "center", marginTop: "9rem" }}>
          ...
          <section className="mt-5">
                          ...
                          <Card.Body>
                              ...
                              <section id="activity">
                                <div className="card mt-5">
                                      <h2 className="fw-bold text-primary mt-5 ml-2">Activity</h2>
                                      <br/> 
                                      <p className="text-justify mb-3 m-4">{courseinfo.Activity1}</p>
                                      <p className="text-justify mb-3 m-4">{courseinfo.Activity2}</p>
                                </div>
                              </section>
                              ...
                              <section id="assess">
                                <div className="mt-2 mb-2 m-3">
                                  ...
                                  <br/> 
                                  <p>Let's level up your skills and knowledge in {courses.Title}, take the assessment and face the challenge. If you successfully withstand with the challenge you will be promoted to a new level. Goodluck young warrior.</p>
                ...
                <Modal show={showA} onHide={handleCloseA}>
                  ...
                  <img className="mx-auto d-block" style={{width: '25%', height: 'auto'}} src={courses.Image} alt={courses.Title} />
                  <br/> 
                      Test your knowledge with these "Assessment of learning quiz questions and answers." 
                      This quiz is about {courses.Title}, the Assessment of Learning is composed of 10 questions, all of the questions will be related 
                      to that subject. You've come to the correct place if you want to put your 
                      understanding to the test and see how well you know the subject. Make an effort to 
                      correctly answer these questions. Finally, your score will offer you an idea. 
                      Let's get started!
                  </Modal.Body>
                  <Modal.Footer>
