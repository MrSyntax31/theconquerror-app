...
const Lessons = () => {
  ...
  const enroll = async function(e){
    ...
    <h2 className="" style={{borderRadius: "50%",  width: "50px", height: "px", backgroundColor: "primary", color: "white", textAlign: "center", fontSize: "20px", fontWeight: "bold", marginBottom: "10px"}}>{courses.Difficulty}</h2>
