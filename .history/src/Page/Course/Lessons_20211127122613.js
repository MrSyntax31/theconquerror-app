        ...
        <section className="features section mt-4">
          ...
          alignItems: "center"
            ...
            <Col className="text-center text-secondary">
              <div className="">
                  <h1 className="text-center text-secondary fw-bold">Welcome to the Programming Course<img variant="top" className="mt-5 w-25" src="https://cdn-icons-png.flaticon.com/512/3763/3763359.png" alt="img-header" /></h1>
