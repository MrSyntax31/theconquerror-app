                          ...
                          <p className="mt-4 mb-5 text-center">
                                ...
                                <Col style={{width: "200px", display: "flex", justifyContent: "center", alignItems: "center"}}>
                                  ...
                                  <Col style={{width: "200px", display: "flex", justifyContent: "center", alignItems: "center"}}>
                                      <Card style={{ width: '18rem', marginTop: '2rem' }}>
                                                <div style={{textAlign:"center"}}>
                                                  <Card.Img variant="top" className="mt-5 w-50" src="https://cdn-icons.flaticon.com/png/512/3131/premium/3131620.png?token=exp=137653582~hmac=6b8ffa9485742e88483da2575aecea59" />
                                                </div>           
                                                  <Card.Body>
