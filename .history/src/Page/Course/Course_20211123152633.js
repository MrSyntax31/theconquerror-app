                  ...
                  <h4 className="text-center text-secondary"> Experience new and better way to learn programming</h4>
                          ...
                          <p className="mt-4 mb-5 text-center">
                                    ...
                                    <div style={{textAlign:"center"}}>
                                      <Card.Img variant="top" className="mt-2 w-50" src="https://cdn-icons.flaticon.com/png/512/4674/premium/4674889.png?token=exp=1637653151~hmac=2a5ddce639deb7b7de6f3ec56f5c90c5" />
                                    </div>
                                    <Card.Body>
