          ...
          alignItems: "center"
            ...
            <Col className="text-center text-secondary">
              <div className="">
                  ...
                  <Card style={{ width: '18rem', marginTop: '2rem' }} className="vertical-center">
                                    <div style={{textAlign:"center"}}>
                                      <Card.Img variant="top" className="mt-2 w-50" src="https://cdn-icons-png.flaticon.com/512/3763/3763359.png" />
                                    </div>
                                    <Card.Body>
                                      <Card.Title>My level: <strong>1</strong> </Card.Title>
                                      <Card.Text>
                                        Level 1: You are about to discover new programming adventures and challenges. 
                                      </Card.Text>
                                    </Card.Body>
                                  </Card>
