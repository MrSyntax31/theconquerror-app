...
const LessonsContent = () => {
  ...
  console.log({courseinfo.pptlink)
                          ...
                          <Card.Body>
                            ...
                            <section id="content" className="mt-5">
                              <Container>                                
                                ...
                                <br/>
                                {<iframe src={courseinfo.pptlink} width="350px" height="221px" frameBorder="0" title="ppt">This is an embedded <a target="_blank" rel="noopener noreferrer" href="https://office.com">Microsoft Office</a> presentation, powered by <a target="_blank" rel="noopener noreferrer" href="https://office.com/webapps">Office</a>.</iframe>      }              
                              </Container>
                            </section>
