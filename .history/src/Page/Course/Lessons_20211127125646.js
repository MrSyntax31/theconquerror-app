...
import { Button, Row, Container, Col, Card, Offcanvas } from 'react-bootstrap';
...
const Lessons = () => {
  ...
  const enroll = async function(e){
    ...
    const showCourse = courses.map((courses) => (  <div key={courses.id} className="card mb-2">
              ...
              <div className="">
                  ...
                  <Card style={{ width: '18rem', marginTop: '2rem' }} className="container mb-4">
                                    ...
                                    <Card.Body>
                                      ...
                                      <Card.Text>
                                        Level -: You are about to discover new programming adventures and challenges. 
                                      </Card.Text>
                                    </Card.Body>
                                  </Card>
