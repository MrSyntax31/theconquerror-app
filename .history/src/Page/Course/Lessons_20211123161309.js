...
const Lessons = () => {
  ...
  const enroll = async function(e){
    ...
    <div className="" style={{borderRadius: "50%",  width: "50px", height: "50px", backgroundColor: "primary", color: "white", textAlign: "center", fontSize: "20px", fontWeight: "bold", marginBottom: "10px"}}>{courses.Difficulty}</div>
