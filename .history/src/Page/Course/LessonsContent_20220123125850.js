  ...
  <div key={courses1.id} className="card mb-5">
    ...
    return (
      ...
      <section className="headNav" style={{marginTop:'1rem'}}>
              <label style={{textAlign: 'left', fontSize: '16px', marginTop: '  5'}} className="shake-little shake-constant shake-constant--hover cursor-pointer mt-3 mb-3 brand" onClick={handleShow}>
