...
<div className="" style={{marginTop:'5rem',  marginBottom:'3rem'}}>
      ...
      <Link to="/course" style={{ textDecoration: 'none', marginLeft:'1rem' }} className="btn btn-primary">Back</Link>
            ...
            <Card className="m-2">
                <Card.Header className="fw-bold"><AiIcons.AiFillCode/> {lessonid}</Card.Header>
                  <Card.Body>

                    <Container>
                      <Row  xs={2} md={4}>
                        <Col xs={6} md={4}>
                          <img className="mx-auto d-block" style={{width: '100%', height: 'auto'}} src={courses.Image} alt={courses.Title} />
                        </Col>
                        <Col xs={12} md={8}>
