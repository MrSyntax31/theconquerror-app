                        ...
                        <Row>
                          <Col>
                            <Card style={{ width: '18rem', marginTop: '2rem' }} className="container mb-4">
                                  <div style={{textAlign:"center"}}>
                                    <Card.Img variant="top" className="mt-2 w-50" src="https://img.icons8.com/color/96/000000/adventures--v3.png" />
                                    <img src="https://img.icons8.com/color/96/000000/adventures--v3.png"/>
                                  </div>
                                <Card.Body>
