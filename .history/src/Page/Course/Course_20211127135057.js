                  ...
                  <div className="">
                    ...
                    <h4 className="text-center text-secondary"> Experience new and better ways to learn computer programming</h4>
                          ...
                          <p className="mt-4 mb-5 text-center">
                                    ...
                                    and as well as students. In this lessons, you can learn and understand the <strong>basic structures</strong>  and <strong></strong>fundamentals of 
                                    computer programming, from concepts, methods, functions, and many more.
                          </p>
