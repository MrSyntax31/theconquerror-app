...
const showCourse = courses1.map((courses1) => (  
  <div key={courses1.id} className="card mb-5">
    ...
    return (
      ...
      <section className="headNav" style={{marginTop:'5rem'}}>
              <label style={{textAlign: 'left', fontSize: '16px'}} className="shake-little shake-constant shake-constant--hover cursor-pointer mt-3 mb-3 brand" onClick={handleShow}>
                <GiIcons.GiBookmarklet/>Spellbook
              </label>
              <br/> <br/> 

                    <a href="#intro" data-toggle="tooltip" data-placement="top" title="Course"><ImIcons.ImFileText/></a>{' '}</br>
