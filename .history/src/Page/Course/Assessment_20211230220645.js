...
export default function Assessment() {
        ...
        const collectionRef = collection(assessmentdb, "Assessment","PROG-BPS102","Quiz","Quiz"+1);
      ...
      <button data-id={quiz.Opt2Correct} onClick={getMore}>Next</button>
