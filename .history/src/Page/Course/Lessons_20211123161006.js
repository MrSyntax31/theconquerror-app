...
const Lessons = () => {
  ...
  const enroll = async function(e){
    ...
    < className="text-primary" style={{borderRadius: "50%",  width: "34px", height: "34px", backgroundColor: "white", color: "black", textAlign: "center", fontSize: "20px", fontWeight: "bold", marginBottom: "10px"}}>{courses.Difficulty}}>{courses.Difficulty}</h2>
