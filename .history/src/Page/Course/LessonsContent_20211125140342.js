...
<div className="" style={{marginTop:'5rem',  marginBottom:'3rem'}}>
      ...
      <Link to="/course" style={{ textDecoration: 'none', marginLeft:'1rem' }} className="btn btn-primary">Back</Link>
            ...
            <Card className="m-2">
                ...
                <Container className="">
                  <Row>
                    <Col md={4} className="fw-boldfs-5" style={{textAlign: 'left'}}><AiIcons.AiFillCode/> {lessonid}</Col>
                    <Col md={{ span: 4, offset: 12 }} className="fw-bold">
                      <div className="shake-little shake-constant shake-constant--hover cursor-pointer btn fs-5" onClick={handleShow}>
