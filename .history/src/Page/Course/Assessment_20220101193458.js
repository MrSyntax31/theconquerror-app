    ...
    return (
        ...
        <section className="assessment section bg-light mt-4">
            ...
            <Container className="mt-3" fluid="md" style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                    ...
                            <label htmlFor="Option1" className="form-check-label options">{quiz.Opt1Wrong}<input type="radio" id="Option1" name="Quiz" className="form-check-input" onChange={e => chooseAnswer(e.target.value)} value={quiz.Opt1Wrong} /><span class="checkmark"></span></label>
