      ...
      <Link to="/course" style={{ textDecoration: 'none', marginLeft:'1rem' }} className="btn btn-primary">Back</Link>
            ...
            <Card className="m-2">
                ...
                <Container className="fs-5">
                  <Row>
                  <Col md={4} className="fw-bold" style={{textAlign: 'left'}}><AiIcons.AiFillCode/> {lessonid}</Col>
                  <Col md={{ span: 4, offset: 12 }} className="fw-bold" ><GiIcons.GiBookmarklet/>
                  <div class="shake-slow shake-constant shake-constant--hover">Spellbook</div></Col>
                  </Row>
              </Container>  
                </Card.Header>
                  <Card.Body>
