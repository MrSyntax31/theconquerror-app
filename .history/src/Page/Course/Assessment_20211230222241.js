...
export default function Assessment() {
        ...
        async function sample(){
          ...
          function next(e){
            ...
            chooseAnswer(e.target.getAttribute("value"))
    ...
    return (
        <div>
            ...
            <Container className="mt-3">
                      ...
                      <input type="radio" id="Option1" name="Quiz" className="form-check-input" onChange={e => setReply(e.target.value)} value={quiz.Opt1Wrong} />
