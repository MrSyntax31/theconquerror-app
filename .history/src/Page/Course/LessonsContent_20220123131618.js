    ...
    return (
      ...
      <section className="headNav">
            <div style={{marginTop: '5rem' }} className="mb-4">
                  ...
                  <br/>
                    <a href="#intro" data-toggle="tooltip" data-placement="top" title="Course" className="text-light" style={{text-decoration: none}}><ImIcons.ImFileText/> Overview</a>{' '}{' '}
                    <a href="#vid" data-toggle="tooltip" data-placement="top" title="Introductory Video"><FaIcons.FaVideo/> Introduction</a>{' '}{' '}
