                            ...
                            <section id="content" className="mt-5">
                              <Container>                                
                                ...
                                {/*PROG-PC101 */}
                                  ...
                                  <h5 className="fw-bold mt-2 mb-3">{courseinfo.bpstitle5}</h5> 
                                  <p>{courseinfo.bpscontent9}</p>
                                  <code>{courseinfo.bpscode1}</code>
                                  <h5 className="fw-bold mt-2 mb-3">{courseinfo.bpstitle6}</h5> 
                                  <p>{courseinfo.bpscontent10}</p>
                                  <code>{courseinfo.bpscode2}</code>
                                  <p>{courseinfo.bpscontent11}</p>
                                  <h5 className="fw-bold mt-2 mb-3">{courseinfo.bpstitle7}</h5> 
                                  <p>{courseinfo.bpscontent12}</p>
                                  <h5 className="fw-bold mt-2 mb-3">{courseinfo.bpstitle8}</h5> 
                                  <p>{courseinfo.bpscontent13}</p>
                                  <h5 className="fw-bold mt-2 mb-3">{courseinfo.bpstitle9}</h5> 
                                  <p>{courseinfo.bpscontent14}</p>
                                  <p>{courseinfo.bpscontent15}</p>
                                  <p>{courseinfo.bpscontent16}</p>
                                  <p>{courseinfo.bpscontent17}</p>
                                  <p>{courseinfo.bpscontent18}</p>
                                  <p>{courseinfo.bpscontent19}</p>
                                  <p>{courseinfo.bpscontent20}</p>
                                  <h5 className="fw-bold mt-2 mb-3">{courseinfo.bpstitle10}</h5> 
                                  <p>{courseinfo.bpscontent21}</p>
                                  <br/>
                                  <h5 className="fw-bold mt-2 mb-3">{courseinfo.bpstitle11}</h5>
                                  <p>{courseinfo.bpscontent22}</p> 
                                  <img className="mx-auto d-block mb-3" style={{width: '50%', height: 'auto'}} src={courseinfo.bpsimage1} alt={courses.Title} />
                                  <p className="text-center font-italic">{courseinfo.bpscaption1}</p>
                                  <h5 className="fw-bold mt-2 mb-3">{courseinfo.bpstitle12}</h5>
                                  <p>{courseinfo.bpscontent23}</p> 
                                  <code>{courseinfo.bpscode3}</code>
                                  <h5 className="fw-bold mt-2 mb-3">{courseinfo.bpstitle13}</h5>
                                  <p>{courseinfo.bpscontent24}</p> 
                                  <code>{courseinfo.bpscode4}</code>
                                  <h5 className="fw-bold mt-2 mb-3">{courseinfo.bpstitle14}</h5>
                                  <p>{courseinfo.bpscontent25}</p>
                                  <code>{courseinfo.bpscode5}</code><br/>
                                  <code>{courseinfo.bpscode6}</code><br/>
                                  <code>{courseinfo.bpscode7}</code><br/>
                                  <code>{courseinfo.bpscode8}</code><br/>
                                  <code>{courseinfo.bpscode9}</code>
                                  <p>{courseinfo.bpscontent26}</p>
                                  <h5 className="fw-bold mt-2 mb-3">{courseinfo.bpstitle15}</h5>
                                  <p>{courseinfo.bpscontent27}</p>
                                  ...
                                  <p>{courseinfo.ncscontent2}</p>
                                  <p>{courseinfo.ncscontent3}</p>
                                  <p>{courseinfo.ncscontent4}</p>
                                  <p>{courseinfo.ncscontent5}</p>
                                  <p>{courseinfo.ncscontent6}</p>
                                  <p>{courseinfo.ncscontent7}</p>
                                  <p>{courseinfo.ncscontent8}</p>
                                  ...
                                  <h5 className="fw-bold mt-3 mb-3">{courseinfo.ncstitle4}</h5>
                                  <p>{courseinfo.ncscontent30}</p>
                                  <p>{courseinfo.ncscontent31}</p>
                                  <p>{courseinfo.ncscontent32}</p>
                                  <h5 className="fw-bold mt-3 mb-3">{courseinfo.ncstitle5}</h5>
                                  <p>{courseinfo.ncscontent33}</p>
                                  <p>{courseinfo.ncscontent34}</p>
                                  <h5 className="fw-bold mt-3 mb-3">{courseinfo.ncstitle6}</h5>
                                  <p>{courseinfo.ncscontent35}</p>
                                  <h5 className="fw-bold mt-3 mb-3">{courseinfo.ncstitle7}</h5>
                                  <p>{courseinfo.ncscontent36}</p>
                                  <code>{courseinfo.ncscode34}</code><br/>
                                  <code>{courseinfo.ncscode35}</code><br/>
                                  <code>{courseinfo.ncscode36}</code><br/>
                                  <code>{courseinfo.ncscode37}</code><br/>
                                  <code>{courseinfo.ncscode38}</code><br/>
                                  <code>{courseinfo.ncscode39}</code><br/>
                                  <code>{courseinfo.ncscode40}</code><br/>
                                  <h5 className="fw-bold mt-3 mb-3">{courseinfo.ncstitle8}</h5>
                                  <p>{courseinfo.ncscontent37}</p>
                                  <code>{courseinfo.ncscode28}</code><br/>
                                  <code>{courseinfo.ncscode29}</code><br/>
                                  <code>{courseinfo.ncscode30}</code><br/>
                                  <code>{courseinfo.ncscode31}</code><br/>
                                  <code>{courseinfo.ncscode32}</code><br/>
                                  <code>{courseinfo.ncscode33}</code><br/>

                                  {/*PROG-LC */}
                                  <h5 className="fw-bold mt-3 mb-3">{courseinfo.lctitle1}</h5>
