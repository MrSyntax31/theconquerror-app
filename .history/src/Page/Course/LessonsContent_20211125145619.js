...
<div className="" style={{marginTop:'5rem',  marginBottom:'3rem'}}>
            ...
            <Card className="m-2">
                ...
                <Container>
                  <Row>
                    <Col className="fw-bold" style={{textAlign: 'left'}}><AiIcons.AiFillCode/> {lessonid}</Col>
    ...
    >
      <iframe 
        ...
        src="https://www.youtube.com/embed/jcYaWFhV8oY" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen
      />
      <iframe src="https://www.youtube.com/embed/vwzlg-wSDH0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
                    </Container>
