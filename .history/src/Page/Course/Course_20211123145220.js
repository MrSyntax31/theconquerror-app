...
import { Button, Row, Container, Col,Badge } from 'react-bootstrap';
        ...
        <section className="features section bg-light mt-5">
          ...
          alignItems: "center"
            ...
            <Col className="text-center text-secondary">
              <div className="">
                  <h1 className="text-center text-secondary fw-bold">Welcome {profile.Name || ''}<Badge bg="secondary">New</Badge> to the Courses Section</h1>
