...
<div className="" style={{marginTop:'5rem',  marginBottom:'3rem'}}>
    ...
    >
      <iframe style={{
          ...
          width: "100%",
          height: "100%"
        }} src="https://www.youtube.com/embed/vwzlg-wSDH0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
                    </Container>
