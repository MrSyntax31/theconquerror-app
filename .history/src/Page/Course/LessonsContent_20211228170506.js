                          ...
                          <Card.Body>
                            ...
                            <section id="content" className="mt-5">
                              <Container>                                
                                ...
                                <br/>
                                <h5 className="fw-bold mb-3">{courseinfo.title2}</h5>  
                                ...
                                <br/>
                                <h5 className="fw-bold mb-3">{courseinfo.title3}</h5> 
                                ...
                                <br/>
                                <h5 className="fw-bold mb-3 mt-3">{courseinfo.title4}</h5>
                                ...
                                <h5 className="fw-bold mb-3 mt-5">{courseinfo.title10}</h5>
