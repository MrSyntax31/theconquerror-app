                              ...
                              <Row>
                                ...
                                <Col sm={8}>
                                    <div
                                                  ...
                                                  >
                                                    <iframe style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%" }} src="https://www.youtube.com/embed/vwzlg-wSDH0" frameBorder="0"/>
                                    </div>
                                </Col>
                              </Row>
                        </Container>                  
          ...
          <Offcanvas show={show} onHide={handleClose}>
            ...
            <Offcanvas.Body>
              ...
              <div className=" d-grid gap-2 mt-3 mb-3">
                    ...
                    <a href="#vid" className="btn page-scroll" aria-label="Toggle navigation">Features</a>
