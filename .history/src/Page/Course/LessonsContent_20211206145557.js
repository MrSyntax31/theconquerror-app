                            ...
                            <section id="content" className="mt-5">
                              <Container>                                
                                ...
                                <p>{courseinfo.content1}</p>
                                  <img className="mx-auto d-block mt-3 mb-3" style={{width: '25%', height: 'auto'}} src={courseinfo.courseimg} alt={courses.Title} />
                                ...
                                <div className="mt-3 mb-3">
                                  <img className="mx-auto d-block mt-3 mb-3" style={{width: '25%', height: 'auto'}} src={courseinfo.courseimg1} alt={courses.Title} />
                                  <p className="text-center font-italic">{courseinfo.caption1}</p>
                                  <img className="mx-auto d-block mt-3 mb-3" style={{width: '25%', height: 'auto'}} src={courseinfo.courseimg2} alt={courses.Title} />
                                  <p className="text-center font-italic">{courseinfo.caption2}</p>
                                  <img className="mx-auto d-block mt-3 mb-3" style={{width: '25%', height: 'auto'}} src={courseinfo.courseimg3} alt={courses.Title} />
