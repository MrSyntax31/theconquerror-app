      ...
      <div fluid="md" className="mb-5" style={{ display: "flex", justifyContent: "center", alignItems: "center", marginTop: "9rem" }}>
          ...
          <section className="mt-5">
                ...
                <Modal show={showA} onHide={handleCloseA}>
                  ...
                  <Modal.Body>
                  Test your knowledge with these "Assessment of learning quiz questions and answers." Because this quiz is about Assessment of Learning, all of the questions will be related to that subject. You've come to the correct place if you want to put your understanding to the test and see how well you know the subject. Make an effort to correctly answer these questions. Finally, your score will offer you an idea. Let's get started!
                  </Modal.Body>
                  <Modal.Footer>
