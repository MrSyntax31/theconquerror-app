    ...
    return (
        ...
        <div>
            ...
            Scenario: A bottle falls from the wall<br/>
               <span className="green">✓</span> <span class="gray">Given 100 green bottles are standing</span><br/>
            <span className="green">✓</span> <span class="gray">when 1 green bottle accidentally falls</span><br/>
           <span className="green">✓</span> <span class="gray">then there are 99 green bottles standing</span><br/>
            <br/>
